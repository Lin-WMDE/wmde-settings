...
xdg-entry-about-keywords = WMDE;About;tietoa;tietoja
...
xdg-entry-comment = Asetussovellus WMDE-työpöydälle
xdg-entry-applications = Sovellukset
xdg-entry-keywords = WMDE;Settings;asetukset;
...
xdg-entry-desktop-keywords = WMDE;Desktop;työpöytä;
xdg-entry-desktop-comment = Taustakuva, ulkoasu, paneeli, telakka, ikkunanhallinta ja työtilojen asetukset
xdg-entry-default-apps-keywords = WMDE;Default;Application;oletus;sovellus;oletussovellus
xdg-entry-date-time-keywords = WMDE;Time;Zone;aika;aikavyöhyke;
...
confirm = Vahvista
settings = Asetukset
xdg-entry-startup-apps-keywords = WMDE;Startup;Application;käynnistys;sovellus;
xdg-entry-panel-keywords = WMDE;Panel;Applet;paneeli;sovelma
xdg-entry-x11-applications-keywords = WMDE;X11;Application;Game;Compatibility;sovellus;peli;yhteensopivuus;
xdg-entry-touchpad-keywords = WMDE;Touchpad;Gesture;kosketuslevy;ele;
xdg-entry-workspaces-keywords = WMDE;Workspace;Orientation;Overview;Monitor;työtila;suunta;yleiskuva;yleisnäkymä;
x-minutes =
    { $number } { $number ->
        [one] minuutti
       *[other] minuuttia
...
xdg-entry-users-keywords = WMDE;User;Account;käyttäjä;tili;tunnus;käyttäjätili;käyttätunnus;
wifi = Wi-Fi
...
xdg-entry-notifications-keywords = WMDE;Notification;Lock;ilmoitus;lukitus;
xdg-entry-keyboard-comment = Syötelähteet, vaihtaminen, erikoismerkkien syöttäminen, pikanäppäimet
xdg-entry-wired-keywords = WMDE;Wired;LAN;Network;Connection;kiinteä;paikallisverkko;langallinen;verkko;yhteys;
xdg-entry-power = Virranhallinta ja akku
xdg-entry-dock-keywords = WMDE;Dock;Panel;Applet;telakka;paneeli;sovelma
...
xdg-entry-system-keywords = WMDE;System;Info;Accounts;Firmware;järjestelmä;tiedot;tilit;laiteohjelmisto;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Network;Connection;langaton;verkko;yhteys;
...
xdg-entry-network-keywords = WMDE;Network;Wireless;WiFi;VPN;verkko;langaton;erillisverkko;
...
xdg-entry-vpn-keywords = WMDE;VPN;Network;Connection;OpenVPN;OpenConnect;verkko;yhteys;netti;
xdg-entry-time-language-keywords = WMDE;System;Time;Date;Region;Language;järjestelmä;aika;kello;päivä;alue;kieli;
xdg-entry-input-keywords = WMDE;Input;Keyboard;Mouse;Mice;syöte;sisääntulo;näppäimistö;hiiri;
xdg-entry-notifications-comment = Älä häiritse, lukitusnäytön ilmoitukset ja sovelluskohtaiset asetukset
xdg-entry-sound-keywords = WMDE;Sound;Audio;Alert;Pipewire;ääni;hälytys;
xdg-entry-power-keywords = WMDE;Power;Battery;virta;virranhallinta;akku
xdg-entry-region-language-keywords = WMDE;Region;Language;Date;Format;Time;Locale;Localization;alue;kieli;päivä;päiväys;muotoile;muoto;aika;kello;lokaali;maa-asetus;lokalisointi;kotoistus;
xdg-entry-applications-keywords = WMDE;Default;Application;Startup;X11;Compatibility;oletus;ohjelma;sovellus;äppi;käynnistys;yhteensopivuus
...
xdg-entry-keyboard-keywords = WMDE;Keyboard;Input;Source;Shortcuts;näppäimistö;syöte;sisääntulo;lähde;pikanäppäimet;
xdg-entry-window-management-keywords = WMDE;Window;Management;Tiling;Super;Key;ikkuna;ikkunanhallinta;laatoitus;laatoita;aseta;asettelu;
...
xdg-entry-mouse-keywords = WMDE;Mouse;Acceleration;Scrolling;hiiri;kiihdytys;vieritys;skrollaus;
xdg-entry-mouse-comment = Hiiren nopeus, kiihdytys ja luonnollinen vieritys
xdg-entry-displays-keywords = WMDE;Display;näyttö;monitori;
xdg-entry-displays-comment = Hallitse näyttöön liittyviä asetuksia
xdg-entry-date-time = Päivä ja aika
xdg-entry-appearance-keywords = WMDE;Accent;Color;Icon;Font;Theme;korostus;aksentti;väri;kuvake;ikoni;fontti;kirjasin;teema
xdg-entry-appearance-comment = Korostusvärit ja teemat
xdg-entry-a11y-keywords = WMDE;Accessibility;A11y;Screen;Reader;Magnifier;Contrast;Color;esteettömyys;näytönlukija;ruudunluku;suurennuslasi;kontrasti;väri;
xdg-entry-about = Tietoa
xdg-entry-wallpaper-keywords = WMDE;Wallpaper;Background;Slideshow;taustakuva;tausta;diaesitys;
...
enable-export = Käytä nykyistä teemaa Gnome-sovelluksiin
    .desc = Kaikki työkalukirjastot eivät tue automaattista vaihtoa. Muut kuin WMDE-sovellukset pitää ehkä käynnistää uudelleen teeman vaihtamisen jälkeen.
...
style = Tyyli
    ...
    .frosted-system-interface = Järjestelmän käyttöliittymä
    .frosted-system-interface-desc = Toteuttaa huurteisen lasin käynnistimeen, sovelluskirjastoon, työtilan yleiskuvaan ja näytöllä näkyviin säätimiin
    .frosted-windows = Ikkunat
    .frosted-windows-desc = Toteuttaa huurteisen lasin ikkunoihin ja vahvistusikkunoihin
    .frosted-panels = Paneelit
    .frosted-panels-desc = Toteuttaa huurteisen lasin paneeliin ja telakkaan
    .frosted-applets = Sovelmat
    .frosted-applets-desc = Toteuttaa huurteisen lasin sovelmavalikkoihin paneelissa ja telakassa
    .frosted-thickness = Huurteen tiheys
    .less = vähemmän
    .more = enemmän
    .glass-opacity = Lasin peittävyys
...
accessibility = Esteettömyys
    ...
    .shake-cursor = Ravista osoitinta paikantaaksesi sen
    .shake-cursor-desc = Ravista nopeasti hiirtä suurentaaksesi osoittimen väliaikaisesti
debug = Vianjäljitys
...
bluetooth-display-passkey = Bluetooth-parinmuodostus

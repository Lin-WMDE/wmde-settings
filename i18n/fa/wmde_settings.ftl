...
wallpaper = تصویر پس زمینه
    .desc = تصاویر پس زمینه، رنگ‌ها و گزینه‌های اسلایدشو.
    .same = پس زمینه یکسان برای همه نمایشگرها
    .fit = متناسب
    .slide = نمایش اسلاید
...
wired = شبکه سیمی
    .desc = اتصال سیمی، پروفایل‌های اتصال

## Networking: Online Accounts

online-accounts = حساب‌های آنلاین
    .desc = افزودن حساب، IMAP و SMTP، ورود به سیستم شرکتی
...
users = کاربران
    .desc = احراز هویت و ورود، قفل صفحه.
save = ذخیره
cancel = لغو

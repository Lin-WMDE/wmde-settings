...
save = Gem
xdg-entry-bluetooth-comment = Håndter Bluetoothenheder
xdg-entry-default-apps-comment = Standardwebbrowser, mailklient, filhåndtering og andre programmer
xdg-entry-appearance-keywords = WMDE;Accent;Farve;Ikon;Skrifttype;Tema
xdg-entry-dock-keywords = WMDE;Dock;Panel;Applet
xdg-entry-a11y = Tilgængelighed
xdg-entry-desktop-keywords = WMDE;Skrivebord;
xdg-entry-displays-comment = Administrer skærmkonfigurationsindstillinger
xdg-entry-default-apps = Standardprogrammer
xdg-entry-applications-comment = Standardprogrammer, opstartsprogrammer og X11 program kompatibilitetsindstillinger
xdg-entry-about-keywords = WMDE;Om
xdg-entry-a11y-keywords = WMDE;Tilgængelighed;A11y;Skærm;Oplæser;Forstørrelse;Kontrast;Farve;
xdg-entry-desktop = Skrivebord
xdg-entry-date-time-keywords = WMDE;Tid;Zone;
xdg-entry-keyboard = Tastatur
xdg-entry-a11y-comment = Skærmoplæsning, forstørrelse, høj kontrast og farvefiltre
xdg-entry-displays = Skærme
xdg-entry-date-time = Dato & tid
xdg-entry-input-comment = Tastatur- og museindstillinger
xdg-entry-bluetooth-keywords = WMDE;Bluetooth;
xdg-entry-dock = Dock
xdg-entry-about-comment = Enhedsnavn, hardwareoplysninger og standardindstillinger for operativsystemet
xdg-entry-appearance-comment = Accentfarver og temaer
xdg-entry-input-keywords = WMDE;Input;Tastatur;Mus;Mus;
xdg-entry-comment = Indstillingsprogram for WMDE skrivebord
xdg-entry-applications = Applikationer
xdg-entry-default-apps-keywords = WMDE;Standard;Program
xdg-entry-keywords = WMDE;Indstillinger;
xdg-entry-about = Om
xdg-entry-input = Inputenheder
xdg-entry-applications-keywords = WMDE;Standard;Program;Opstart;X11;Kompatibilitet
xdg-entry-appearance = Udseende
xdg-entry-displays-keywords = WMDE;Skærm;
xdg-entry-date-time-comment = Tidszone, automatiske ur-indstillinger og tidsformat
xdg-entry-desktop-comment = Baggrund, udseende, panel, dock, vindueshåndtering og arbejdsområder
xdg-entry-dock-comment = En valgfri bjælke til apps og applets

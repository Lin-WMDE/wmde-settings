...
style = Стиль
    ...
    .frosted-system-interface = Системні елементи
    .frosted-system-interface-desc = Розмиття запускача, бібліотеки застосунків, режиму огляду й елементів керування
    .frosted-windows = Вікна
    .frosted-windows-desc = Розмиття вікон і діалогових вікон
    .frosted-panels = Панелі
    .frosted-panels-desc = Розмиття панелі й області завдань
    .frosted-applets = Віджети
    .frosted-applets-desc = Розмиття спливних меню віджетів
    .frosted-thickness = Щільність
    .less = Менше
    .more = Більше
    .glass-opacity = Прозорість скла
...
pointer-crossing = Пропорційний перехід курсора між екранами
    .desc = Курсор потрапляє на сусідній екран на тій самій частці його межі. Якщо вимкнено, він зберігає свою координату, і частина більшого екрана лишається недосяжною.
    .while-dragging = Застосовувати під час перетягування вікна
    .while-dragging-desc = Вимкнено: вікно перетинає межу без ривка
...
sound-applications = Застосунки
    ...
    .none = Жоден застосунок не відтворює звук
...
keyboard-special-char = Введення спеціальних символів
    ...
    .ctrl = Control
    .ctrl-right = Правий Ctrl
    .swap-with-ctrl = Поміняти місцями з Control
    .alt = Alt
    .alt-left = Лівий Alt
    .alt-right = Правий Alt
    .super = Super
    .super-left = Лівий Super
    .super-right = Правий Super
    .menu = Клавіша контекстного меню
    .backspace = Backspace
    .escape = Escape
    .swap-with-escape = Поміняти місцями з Escape
...
vpn-error = Помилка VPN
    ...
    .openvpn-config-path = Неправильний шлях до файлу конфігурації OpenVPN
    .openvpn-config-path-desc = Вибраний файл повинен знаходитися в локальній файловій системі.
...
accessibility = Доступність
    ...
    .shake-cursor = Потрусіть вказівником, щоб знайти його
    .shake-cursor-desc = Швидко потрусіть мишею, щоби тимчасово збільшити вказівник
hearing = Слух
...
xdg-entry-comment = Застосунок налаштувань для середовища WMDE
...
xdg-entry-mouse-keywords = WMDE;Миша;Прискорення;Прокручування;Гортання;
xdg-entry-notifications-keywords = WMDE;Сповіщення;Блокування;
xdg-entry-startup-apps-keywords = WMDE;Автозапуск;Запуск;Застосунок;Програма;
xdg-entry-wired-keywords = WMDE;Дротове;LAN;Мережа;З'єднання;Підключення;
xdg-entry-appearance-keywords = WMDE;Колір;Акценту;Піктограма;Іконка;Значок;Шрифт;Черенки;Тема
xdg-entry-dock-keywords = WMDE;Область;Завдань;Док;Панель;Віджет
xdg-entry-panel-keywords = WMDE;Панель;Віджет
xdg-entry-desktop-keywords = WMDE;Стільниця;
xdg-entry-x11-applications-keywords = WMDE;X11;Застосунок;Програма;Гра;Сумісність;
xdg-entry-touchpad-keywords = WMDE;Сенсорна;Панель;Тачпад;Жести;
xdg-entry-system-keywords = WMDE;Про;Систему;Система;Інформація;Облікові;Записи;Обліковка;Мікропрограма;Прошивка;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Мережа;З'єднання;Підключення;
xdg-entry-about-keywords = WMDE;Про;Систему
xdg-entry-a11y-keywords = WMDE;Доступність;Екран;Читач;Диктор;Лупа;Контраст;Колір;
xdg-entry-date-time-keywords = WMDE;Час;Часовий;Пояс;
xdg-entry-network-keywords = WMDE;Мережа;Бездротове;WiFi;VPN;
xdg-entry-workspaces-keywords = WMDE;Робочий;Простір;Простори;Режим;Огляду;Огляд;Орієнтація;Монітор;
xdg-entry-wallpaper-keywords = WMDE;Тло;Шпалери;Показ;Слайдів;
xdg-entry-users-keywords = WMDE;Користувач;Обліковий;Запис;Обліковка;
xdg-entry-vpn-keywords = WMDE;VPN;Мережа;З'єднання;Підключення;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = WMDE;Система;Час;Дата;Регіон;Мова;
xdg-entry-input-keywords = WMDE;Ввід;Клавіатура;Миша;Миші;
xdg-entry-sound-keywords = WMDE;Звук;Аудіо;Сповіщення;Сигнал;Pipewire;
xdg-entry-power-keywords = WMDE;Живлення;Акумулятор
xdg-entry-default-apps-keywords = WMDE;Типові;Застосунки;Програми
xdg-entry-keywords = WMDE;Налаштування;Настройки;
xdg-entry-region-language-keywords = WMDE;Регіон;Мова;Дата;Формат;Час;Локалізація;
xdg-entry-applications-keywords = WMDE;Автозапуск;X11;Типові;Застосунок;Програма;Запуск;Сумісність;
xdg-entry-keyboard-keywords = WMDE;Клавіатура;Ввід;Джерело;Сполучення;Клавіш;
xdg-entry-window-management-keywords = WMDE;Керувати;Вікнами;Укладання;Мозаїка;Tiling;Клавіша;Super;
xdg-entry-displays-keywords = WMDE;Дисплей;Екран;
xdg-entry-bluetooth-keywords = WMDE;Bluetooth;Блютуз;Бездротове;З’єднання;
...
bluetooth-display-pin = Злучення Bluetooth

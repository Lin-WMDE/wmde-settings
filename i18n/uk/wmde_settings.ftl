...
xdg-entry-mouse-keywords = WMDE;Миша;Прискорення;Прокручування;Гортання;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-notifications-keywords = WMDE;Сповіщення;Блокування;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-startup-apps-keywords = WMDE;Автозапуск;Запуск;Застосунок;Програма;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-wired-keywords = WMDE;Дротове;LAN;Мережа;З'єднання;Підключення;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-appearance-keywords = WMDE;Колір;Акценту;Піктограма;Іконка;Значок;Шрифт;Черенки;Тема;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-dock-keywords = WMDE;Область;Завдань;Док;Панель;Віджет;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-panel-keywords = WMDE;Панель;Віджет;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-desktop-keywords = WMDE;Стільниця;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-x11-applications-keywords = WMDE;X11;Застосунок;Програма;Гра;Сумісність;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-touchpad-keywords = WMDE;Сенсорна;Панель;Тачпад;Жести;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-system-keywords = WMDE;Про;Систему;Система;Інформація;Облікові;Записи;Обліковка;Мікропрограма;Прошивка;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Мережа;З'єднання;Підключення;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-about-keywords = WMDE;Про;Систему;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-a11y-keywords = WMDE;Доступність;Екран;Читач;Диктор;Лупа;Контраст;Колір;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-date-time-keywords = WMDE;Час;Часовий;Пояс;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-network-keywords = WMDE;Мережа;Бездротове;WiFi;VPN;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-workspaces-keywords = WMDE;Робочий;Простір;Простори;Режим;Огляду;Огляд;Орієнтація;Монітор;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-wallpaper-keywords = WMDE;Тло;Шпалери;Показ;Слайдів;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-users-keywords = WMDE;Користувач;Обліковий;Запис;Обліковка;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-vpn-keywords = WMDE;VPN;Мережа;З'єднання;Підключення;OpenVPN;OpenConnect;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-time-language-keywords = WMDE;Система;Час;Дата;Регіон;Мова;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-input-keywords = WMDE;Ввід;Клавіатура;Миша;Миші;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-sound-keywords = WMDE;Звук;Аудіо;Сповіщення;Сигнал;Pipewire;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-power-keywords = WMDE;Живлення;Акумулятор;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-default-apps-keywords = WMDE;Типові;Застосунки;Програми;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-keywords = WMDE;Налаштування;Настройки;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-region-language-keywords = WMDE;Регіон;Мова;Дата;Формат;Час;Локалізація;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-applications-keywords = WMDE;Автозапуск;X11;Типові;Застосунок;Програма;Запуск;Сумісність;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-keyboard-keywords = WMDE;Клавіатура;Ввід;Джерело;Сполучення;Клавіш;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-window-management-keywords = WMDE;Керувати;Вікнами;Укладання;Мозаїка;Tiling;Клавіша;Super;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-displays-keywords = WMDE;Дисплей;Екран;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-bluetooth-keywords = WMDE;Bluetooth;Блютуз;Бездротове;З’єднання;КОСМІК;КОСМОС;КОСМІЧНЕ;

...
enable-export = Bu temayı GNOME uygulamalarına uygula
    .desc = Bütün toolkitler otomatik tema değişimi desteklemez. WMDE dışı uygulamaların tema değişimi için uygulamanın yeniden başlatılması gerekebilir.
...
xdg-entry-mouse-keywords = WMDE;Fare; Hızlanma; Kaydırma;
xdg-entry-bluetooth-comment = Bluetooth cihazlarını yönetin
xdg-entry-notifications-keywords = WMDE;Bildirim;Kilit;
...
xdg-entry-appearance-keywords = WMDE;Vurgu;Renk;Simge;Yazı Tipi;Tema
xdg-entry-mouse = Fare
xdg-entry-dock-keywords = WMDE;Dock;Panel;Eklenti
xdg-entry-mouse-comment = Fare hızı, ivme ve doğal kaydırma
xdg-entry-panel-keywords = WMDE;Panel;Eklenti
xdg-entry-a11y = Erişilebilirlik
xdg-entry-desktop-keywords = WMDE;Masaüstü;
...
xdg-entry-about-keywords = WMDE;Hakkında
xdg-entry-panel = Panel
xdg-entry-notifications = Bildirimler
xdg-entry-a11y-keywords = WMDE;Erişilebilirlik;A11y;Ekran;Okuyucu;Büyüteç;Kontrast;Renk;
xdg-entry-desktop = Masaüstü
xdg-entry-date-time-keywords = WMDE;Saat;Zaman Dilimi;
...
xdg-entry-network-keywords = WMDE;Ağ;Kablosuz;WiFi;VPN;
xdg-entry-dock = Dock
...
xdg-entry-input-keywords = WMDE;Giriş;Klavye;Fare;Fareler;
xdg-entry-comment = WMDE masaüstü için ayarlar uygulaması
...
xdg-entry-default-apps-keywords = WMDE;Varsayılan;Uygulama
xdg-entry-keywords = WMDE;Ayarlar;
xdg-entry-about = Hakkında
xdg-entry-input = Giriş Cihazları
xdg-entry-applications-keywords = WMDE;Varsayılan;Uygulama;Başlangıç;X11;Uyumluluk
xdg-entry-keyboard-keywords = WMDE;Klavye;Giriş;Kaynak;Kısayollar;
...
xdg-entry-displays-keywords = WMDE;Ekran;
...
xdg-entry-startup-apps-keywords = WMDE;Başlangıç;Uygulama;
xdg-entry-wired-keywords = WMDE;Kablolu; Yerel Ağ; Ağ; Bağlantı;
...
xdg-entry-x11-applications-keywords = WMDE;X11;Uygulama;Oyun;Uyumluluk;
xdg-entry-touchpad-keywords = WMDE;Dokunmatik yüzey; Hareket;
xdg-entry-time-language = Zaman & Dil
xdg-entry-users = Kullanıcılar
xdg-entry-system-keywords = WMDE;Sistem;Bilgi;Hesaplar;Cihaz Yazılımı;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Ağ; Bağlantı;
...
xdg-entry-workspaces-keywords = WMDE;Çalışma Alanı; Yönlendirme; Genel Bakış; Monitör;
...
xdg-entry-wallpaper-keywords = WMDE;Duvar kağıdı; Arka plan; Slayt gösterisi;
xdg-entry-users-keywords = WMDE;Kullanıcı;Hesap;
xdg-entry-vpn-keywords = WMDE;VPN;Ağ;Bağlantı;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = WMDE;Sistem;Saat;Tarih;Bölge;Dil;
xdg-entry-sound-keywords = WMDE;Ses;Sesli;Uyarı;Kablolu Sistem;
xdg-entry-power-keywords = WMDE;Güç;Pil
xdg-entry-region-language-keywords = WMDE;Bölge;Dil;Tarih;Biçim;Saat;Yerel Ayar;Yerelleştirme;
...
xdg-entry-window-management-keywords = WMDE;Pencere;Yönetim;Döşeme;Süper;Anahtar;

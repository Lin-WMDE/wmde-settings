...
enable-export = 將目前主題套用至 GNOME 應用程式
    .desc = 並非所有工具組都支援自動切換。非 WMDE 應用程式在主題變更後可能需要重新啟動。
icon-theme = 圖示主題
    .desc = 套用不同的圖示集至應用程式
text-tint = 介面文字色調
...
xdg-entry-sound-keywords = WMDE;Sound;Audio;Alert;Pipewire;音效;音訊;提醒;
xdg-entry-power-keywords = WMDE;電源;電池
xdg-entry-region-language-keywords = WMDE;地區;語言;日期;格式;時間;本地;本地化;
xdg-entry-sound-comment = 裝置、提醒和應用程式的音訊設定
xdg-entry-panel-comment = 用於選單和小程式的主要系統列
xdg-entry-sound = 音效
xdg-entry-power-comment = 電源模式和省電選項
xdg-entry-network-keywords = WMDE;網路;無線;WiFi;VPN;
xdg-entry-network-comment = 管理網路連線
xdg-entry-network = 網路與無線
xdg-entry-mouse-keywords = WMDE;滑鼠;加速度;滾動;
xdg-entry-mouse-comment = 滑鼠速度、加速度和自然滾動
xdg-entry-mouse = 滑鼠
xdg-entry-keyboard-keywords = WMDE;鍵盤;輸入;輸入源;快速鍵;
xdg-entry-keyboard-comment = 輸入源、切換、特殊字符輸入、快速鍵
xdg-entry-keyboard = 鍵盤
xdg-entry-input-keywords = WMDE;輸入;鍵盤;滑鼠;
...
xdg-entry-startup-apps-keywords = WMDE;開機啟動;應用程式;
xdg-entry-wired-keywords = WMDE;有線連接;LAN;網路;連接;
xdg-entry-system = 系統與帳號
xdg-entry-window-management = 視窗管理
xdg-entry-time-language-comment = 管理系統日期、時間、區域及語言
xdg-entry-x11-applications-keywords = WMDE;X11;應用程式;遊戲;相容性;
xdg-entry-time-language = 時間與語言
xdg-entry-users = 使用者
xdg-entry-system-keywords = WMDE;系統;資訊;帳號;韌體;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;網路;連接;
...
xdg-entry-workspaces-keywords = WMDE;工作區;方向;總覽;螢幕;
xdg-entry-system-comment = 系統資訊、帳號及韌體更新
xdg-entry-x11-applications-comment = X11 視窗系統應用程式縮放大小、主要顯示螢幕和整體快速鍵
xdg-entry-wallpaper-keywords = WMDE;背景圖片;背景;投影片;
xdg-entry-users-keywords = WMDE;使用者;帳戶;
xdg-entry-vpn-keywords = WMDE;VPN;網路;連接;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = WMDE;系統;時間;日期;地區;語言;
xdg-entry-touchpad-comment = 觸控板速度、點按選項及手勢
xdg-entry-vpn-comment = VPN 連接和連接設定檔案
xdg-entry-window-management-keywords = WMDE;視窗;管理;平鋪;Super;鍵;
...
network-name = 網路名稱
xdg-entry-touchpad-keywords = WMDE;觸控板;手勢;
xdg-entry-comment = WMDE 桌面設定應用程式

...
enable-export = Aplicar o tema atual para aplicativos GNOME
    .desc = Nem todos os toolkits suportam trocar automaticamente. Aplicativos que não são de WMDE podem precisar ser reiniciados após uma mudança de tema.
...
style = Estilo
    ...
    .frosted-system-interface-desc = Aplica efeito de vidro fosco ao lançador, à biblioteca de aplicativos, à visão geral do espaço de trabalho e aos controles na tela
    ...
    .frosted-applets-desc = Aplica efeito de vidro fosco aos menus de miniaplicativos no painel e na dock
...
xdg-entry-mouse-keywords = WMDE;Mouse;Aceleração;Rolagem;
xdg-entry-bluetooth-comment = Gerenciar dispositivos Bluetooth
xdg-entry-notifications-keywords = WMDE;Notificação;Bloqueio;
xdg-entry-startup-apps-keywords = WMDE;Iniciar;Inicialização;Aplicativo;
...
xdg-entry-wired-keywords = WMDE;Wired;Cabeada;LAN;Rede;Conexão;
xdg-entry-power = Energia e bateria
xdg-entry-appearance-keywords = WMDE;Destaque;Accent;Cor;Ícone;Fonte;Tema
xdg-entry-mouse = Mouse
xdg-entry-dock-keywords = WMDE;Dock;Painel;Applet;Miniaplicativo
xdg-entry-mouse-comment = Velocidade do mouse, aceleração e rolagem natural
xdg-entry-system = Sistema e contas
xdg-entry-panel-keywords = WMDE;Painel;Applet;Miniaplicativo
...
xdg-entry-desktop-keywords = WMDE;Desktop;Área;Trabalho;
xdg-entry-x11-applications-keywords = WMDE;X11;Aplicativo;Jogos;Compatibilidade;
xdg-entry-displays-comment = Gerenciar configurações de tela
xdg-entry-touchpad-keywords = WMDE;Touchpad;Gestos;
xdg-entry-time-language = Hora e idioma
xdg-entry-users = Usuários
xdg-entry-system-keywords = WMDE;Sistema;Info;Contas;Firmware;
xdg-entry-default-apps = Aplicativos padrão
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Rede;Conexão;
...
xdg-entry-a11y-keywords = WMDE;Acessibilidade;A11y;Tela;Leitor;Lupa;Ampliador;Contraste;Cor;
xdg-entry-wireless-comment = Conexões Wi-Fi e perfis de conexão
xdg-entry-desktop = Área de trabalho
xdg-entry-date-time-keywords = WMDE;Hora;Fuso;
...
xdg-entry-network-keywords = WMDE;Rede;Conexão;fio;Wireless;WiFi;VPN;
...
xdg-entry-workspaces-keywords = WMDE;Espaço;Trabalho;Orientação;Visão;Geral;Monitor;Tela;
...
xdg-entry-wallpaper-keywords = WMDE;Wallpaper;PapelParede;Background;Slideshow;Transição;Plano;Fundo;
xdg-entry-users-keywords = WMDE;Usuário;Conta;
xdg-entry-about-comment = Nome do dispositivo, informações de hardware, padrões do sistema operacional
xdg-entry-vpn-keywords = WMDE;VPN;Rede;Conexão;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Cores de destaque e temas
xdg-entry-time-language-keywords = WMDE;Sistema;Hora;Data;Região;idioma;
xdg-entry-input-keywords = WMDE;Entrada;Teclado;Mouse;
xdg-entry-comment = Aplicativo de configurações para o ambiente WMDE
...
xdg-entry-sound-keywords = WMDE;Som;Áudio;Alerta;Pipewire;
xdg-entry-power-keywords = WMDE;Energia;Bateria
xdg-entry-default-apps-keywords = WMDE;Padrão;Aplicativo
xdg-entry-keywords = WMDE;Configurações;
xdg-entry-region-language-keywords = WMDE;Região;Idioma;Data;Formato;Hora;Localização;
xdg-entry-about = Sobre
xdg-entry-input = Dispositivos de entrada
xdg-entry-applications-keywords = WMDE;Padrão;Aplicativo;Inicialização;Iniciar;X11;Compatibilidade
...
xdg-entry-keyboard-keywords = WMDE;Teclado;Entrada;Dispositivos;Atalhos;
xdg-entry-vpn-comment = Conexões VPN e perfis de conexão
xdg-entry-appearance = Aparência
xdg-entry-window-management-keywords = WMDE;Janela;Gerenciamento;Tiling;Lado;Super;Tecla;
...
xdg-entry-displays-keywords = WMDE;Tela;Monitor;

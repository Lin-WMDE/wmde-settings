...
auto-switch = Bytt automatisk mellom Lyst og Mørkt tema
    .sunrise = Bytter til Lyst tema ved soloppgang
    .sunset = Bytter til Mørkt tema ved solnedgang
    .next-sunrise = Bytter til Lyst tema ved neste soloppgang
    .next-sunset = Bytter til Mørkt tema ved neste solnedgang
panel-missing = Panelkonfigurasjon Mangler
    .desc = Panelkonfigurasjonsfilen mangler på grunn av en egendefinert konfigurasjon eller er ødelagt.
    .fix = Tilbakestill til standard
dock = Dock
    .desc = En valgfri linje for apper og appletter.
super-key = Super-tast-handling
    .launcher = Åpne Starter
    .workspaces = Åpne Arbeidsområder

...
xdg-entry-applications-keywords = WMDE;Default;Application;Startup;X11;Compatibility
...
xdg-entry-date-time-keywords = WMDE;Time;Zone;
...
xdg-entry-default-apps-keywords = WMDE;Default;Application
...
xdg-entry-displays-keywords = WMDE;Display;
...
xdg-entry-notifications-keywords = WMDE;Notification;Lock;
...
xdg-entry-power-keywords = WMDE;Power;Battery
...
xdg-entry-x11-applications-keywords = WMDE;X11;Application;Game;Compatibility;
...
enable-export = Apply current theme to GNOME apps
    .desc = Not all toolkits support auto-switching. Non-WMDE apps may need to be restarted after a theme change.

...
enable-export = Applica questo tema alle app GNOME.
    .desc = Non tutte le applicazioni supportano l'auto-switch. Le app Non-WMDE potrebbero dover essere riavviate dopo aver cambiato tema.

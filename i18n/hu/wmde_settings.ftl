...
frosted = Tejüveghatás a rendszerfelületen
...
style = Stílus
    ...
    .frosted-system-interface-desc = Tejüveghatás alkalmazása az Indítóra, az alkalmazáskönyvtárra, a munkaterület-áttekintőre és a képernyőn megjelenő vezérlőkre
    .frosted-windows = Ablakok
    .frosted-windows-desc = Tejüveghatás alkalmazása az ablakokra és a párbeszédablakokra
    .frosted-panels = Panelek
    .frosted-panels-desc = Tejüveghatás alkalmazása a panelre és a dokkra
    .frosted-applets = Kisalkalmazások
    .frosted-applets-desc = Tejüveghatás alkalmazása a panelen és a dokkon lévő kisalkalmazások menüire

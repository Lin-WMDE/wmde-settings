...
wallpaper = Háttérkép
    ...
    .folder-dialog = Háttérképmappa kiválasztása
...
frosted = Mattüveghatás a rendszerfelületen
...
enable-export = Jelenlegi téma alkalmazása a GNOME-alkalmazásokra
    .desc = Nem minden eszközkészlet támogatja az automatikus váltást. Előfordulhat, hogy a téma módosítása után újra kell indítani a nem WMDE-alkalmazásokat.
icon-theme = Ikontéma
...
style = Stílus
    ...
    .frosted-system-interface = Rendszerfelület
    .frosted-system-interface-desc = Mattüveghatás alkalmazása az Indítóra, az alkalmazáskönyvtárra, a munkaterület-áttekintőre és a képernyőn megjelenő vezérlőkre
    .frosted-windows = Ablakok
    .frosted-windows-desc = Mattüveghatás alkalmazása az ablakokra és a párbeszédablakokra
    .frosted-panels = Panelek
    .frosted-panels-desc = Mattüveghatás alkalmazása a panelre és a dokkra
    .frosted-applets = Kisalkalmazások
    .frosted-applets-desc = Mattüveghatás alkalmazása a panelen és a dokkon lévő kisalkalmazások menüire
    .frosted-thickness = Homályosítás mértéke
    .less = kevesebb
    .more = több
    .glass-opacity = Üveg átlátszatlansága
...
keyboard-special-char = Speciális karakter beírása
    ...
    .ctrl = Ctrl
    .ctrl-right = Jobb Ctrl
    .swap-with-ctrl = Felcserélés a Ctrl billentyűvel
    .alt = Alt
    .alt-left = Bal Alt
    .alt-right = Jobb Alt
    .super = Super
    .super-left = Bal Super
    .super-right = Jobb Super
    .menu = Menü billentyű
    .backspace = Backspace
    .escape = Esc
    .swap-with-escape = Felcserélés az Esc billentyűvel
...
workspaces-overview = Munkaterületek áttekintése
    ...
    .launcher = Indító megnyitása
    .applications = Alkalmazások megnyitása
xdg-entry-mouse-keywords = WMDE;Egér;Gyorsítás;Görgetés;
xdg-entry-notifications-keywords = WMDE;Értesítés;Zárolás;Ne zavarjanak;
xdg-entry-startup-apps-keywords = WMDE;Automatikus;Indítási alkalmazás;
xdg-entry-appearance-keywords = WMDE;Kiemelő;Szín;Ikon;Betűkészlet;Téma;
xdg-entry-dock-keywords = WMDE;Dokk;Panel;Kisalkalmazás;
xdg-entry-panel-keywords = WMDE;Panel;Kisalkalmazás;
xdg-entry-time-language-comment = Rendszerdátum, idő, régió és a nyelv kezelése
xdg-entry-desktop-keywords = WMDE;Asztal;
xdg-entry-system-keywords = WMDE;Rendszer;Információk;Fiókok;Firmware;
xdg-entry-about-keywords = WMDE;Névjegy;
xdg-entry-panel = Panel
xdg-entry-a11y-keywords = WMDE;Akadálymentesség;Képernyő;Olvasó;Nagyító;Kontraszt;Szín;
xdg-entry-date-time-keywords = WMDE;Idő;Zóna;
...
xdg-entry-network-keywords = WMDE;Hálózat;Vezeték;Nélküli;WiFi;VPN;
xdg-entry-system-comment = Rendszerinformációk, fiókok és firmware-frissítések
xdg-entry-time-language-keywords = WMDE;Rendszer;Idő;Dátum;Régió;Nyelv;
xdg-entry-input-keywords = WMDE;Bevitel;Billentyűzet;Egér;Egerek;
xdg-entry-sound-keywords = WMDE;Hang;Figyelmeztetés;PipeWire;
xdg-entry-power-keywords = WMDE;Energia;Akkumulátor;
xdg-entry-default-apps-keywords = WMDE;Alapértelmezett;Alkalmazások;
xdg-entry-keywords = WMDE;Beállítások;
xdg-entry-region-language-keywords = WMDE;Régió;Nyelv;Dátum;Formátum;Idő;Területi;Beállítások;
xdg-entry-applications-keywords = WMDE;Alapértelmezett;Alkalmazások;Indítás;X11;Támogatás;
xdg-entry-keyboard-keywords = WMDE;Billentyűzet;Beviteli;Forrás;Gyorsbillentyűk;
xdg-entry-displays-keywords = WMDE;Kijelző;
xdg-entry-wired-keywords = WMDE;Vezetékes;LAN;Hálózat;Kapcsolat;
xdg-entry-x11-applications-keywords = WMDE;X11;Alkalmazás;Játék;Támogatás;
xdg-entry-touchpad-keywords = WMDE;Érintőpárna;Mozdulat;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Hálózat;Kapcsolat;
xdg-entry-wireless = Wi-Fi
xdg-entry-workspaces-keywords = WMDE;Munkaterület;Tájolás;Áttekintés;Monitor;Kijelző;Képernyő;
xdg-entry-wallpaper-keywords = WMDE;Háttérkép;Háttér;Diavetítés;
xdg-entry-users-keywords = WMDE;Felhasználó;Fiók;
xdg-entry-vpn-keywords = WMDE;VPN;Hálózat;Kapcsolat;OpenVPN;OpenConnect;
xdg-entry-comment = Beállításalkalmazás a WMDE asztalhoz
xdg-entry-window-management-keywords = WMDE;Ablak;Kezelés;Csempézés;Super;Billentyű;

...
vpn-error = VPN 错误
    ...
    .openvpn-config-path = OpenVPN 配置文件路径无效
    .openvpn-config-path-desc = 所选文件必须在本地文件系统上。
...
enable-export = 将此主题应用到 GNOME 应用程序
    .desc = 并非所有工具包都支持自动切换。非 WMDE 应用程序可能需要在主题更改后重新启动。
icon-theme = 图标主题
    .desc = 为应用程序应用另一套图标集
text-tint = 界面文字色调
...
style = 样式
    ...
    .frosted-system-interface = 系统界面
    .frosted-system-interface-desc = 将磨砂玻璃应用于启动器、应用程序库、 工作区总览、屏幕控件
    .frosted-windows = 窗口
    .frosted-windows-desc = 将磨砂玻璃应用于窗口和对话框
    .frosted-panels = 面板
    .frosted-panels-desc = 将磨砂玻璃应用于面板和程序坞
    .frosted-applets = 小部件
    .frosted-applets-desc = 将磨砂玻璃应用于处在面板与程序坞的小部件
...
keyboard-special-char = 特殊字符输入
    ...
    .caps = 大写锁定键
    .ctrl = Control 键
    .ctrl-right = 右 Control 键
    .swap-with-ctrl = Control 键互换
    .alt = Alt 键
    .alt-left = 左 Alt 键
    .alt-right = 右 Alt 键
    .super = Super 键
    .super-left = 左 Super 键
    .super-right = 右 Super 键
    .menu = Menu 键
    .backspace = 退格键
    .escape = Escape 键
    .swap-with-escape = Escape 键互换
    .print-screen = Print Screen 键
    .scroll-lock = Scroll Lock 键
    .none = 无
...
workspaces-overview = 工作区总览
    ...
    .launcher = 开启启动器
    .applications = 打开应用程序
xdg-entry-about-keywords = WMDE;关于
xdg-entry-wireless = Wi-Fi
xdg-entry-comment = WMDE 桌面的设置应用程序
xdg-entry-mouse-keywords = WMDE;鼠标;加速度;滚动;
xdg-entry-notifications-keywords = WMDE;通知;锁屏;
xdg-entry-startup-apps-keywords = WMDE;自动启动;应用程序;
xdg-entry-wired-keywords = WMDE;有线;LAN;网络;连接;
xdg-entry-appearance-keywords = WMDE;主题色;颜色;图标;字体;主题
xdg-entry-dock-keywords = WMDE;程序坞;面板;小部件
xdg-entry-panel-keywords = WMDE;面板;小部件
xdg-entry-time-language-comment = 管理系统日期、时间、地区和语言
xdg-entry-desktop-keywords = WMDE;桌面;
xdg-entry-x11-applications-keywords = WMDE;X11;应用程序;游戏;兼容性;
xdg-entry-touchpad-keywords = WMDE;触摸板;手势;
xdg-entry-system-keywords = WMDE;系统;信息;账户;固件;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;网络;连接;
xdg-entry-a11y-keywords = WMDE;无障碍;A11y;屏幕;阅读器;放大镜;对比;对比度;颜色;色彩;
xdg-entry-date-time-keywords = WMDE;时间;时区;
xdg-entry-desktop-comment = 壁纸、外观、面板、程序坞、窗口管理和工作区设置
xdg-entry-bluetooth-keywords = WMDE;蓝牙;
xdg-entry-network-keywords = WMDE;网络;无线;WiFi;VPN;
xdg-entry-workspaces-keywords = WMDE;工作区;方向;总览;显示屏;
xdg-entry-wallpaper-keywords = WMDE;壁纸;背景;幻灯片;
xdg-entry-users-keywords = WMDE;用户;账户;
xdg-entry-vpn-keywords = WMDE;VPN;网络;连接;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = WMDE;系统;时间;日期;地区;语言;
xdg-entry-input-keywords = WMDE;输入;键盘;鼠标;
xdg-entry-sound-keywords = WMDE;声音;音频;警报;Pipewire;
xdg-entry-power-keywords = WMDE;电源;电池
xdg-entry-default-apps-keywords = WMDE;默认;应用程序
xdg-entry-keywords = WMDE;设置;
xdg-entry-region-language-keywords = WMDE;地区;语言;日期;格式;时间;当地;本地化;
xdg-entry-applications-keywords = WMDE;默认;应用程序;自动启动;X11;兼容性
xdg-entry-keyboard-keywords = WMDE;键盘;输入;输入源;快捷键;
xdg-entry-window-management-keywords = WMDE;窗口;管理;平铺;Super;键;
xdg-entry-displays-keywords = WMDE;显示器;屏幕;
no-search-results = 无网络符合您的搜索。
workspaces-navigation = 导航
    .wraparound = 使用快捷键和手势在第一个和最后一个工作区间切换
bluetooth-display-passkey = 蓝牙配对

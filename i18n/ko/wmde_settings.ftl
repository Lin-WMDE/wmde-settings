...
enable-export = 현재 테마를 GNOME 앱에 적용
    .desc = 모든 툴킷이 테마 자동 전환을 지원하지는 않습니다. WMDE 이외의 앱은 테마를 변경한 후 앱을 다시 시작해야 할 수도 있습니다.
...
keyboard-special-char = 특수 문자 입력
    ...
    .caps = Caps Lock 키
xdg-entry-wired = 유선
xdg-entry-mouse-keywords = WMDE;마우스;가속;스크롤;
xdg-entry-bluetooth-comment = 블루투스 장치 관리
xdg-entry-notifications-keywords = WMDE;알림;잠금;
xdg-entry-default-apps-comment = 기본 웹 브라우저와 메일 클라이언트, 파일 탐색기 및 다른 앱
xdg-entry-keyboard-comment = 입력 소스, 전환, 특수 문자 모음, 단축키
xdg-entry-wired-keywords = WMDE;유선;LAN;네트워크;연결;
xdg-entry-power = 전원 & 배터리
xdg-entry-appearance-keywords = WMDE;강조;색상;아이콘;글꼴;테마
xdg-entry-mouse = 마우스
xdg-entry-dock-keywords = WMDE;독;패널;애플릿
xdg-entry-mouse-comment = 마우스 속도와 가속 및 자연스러운 스크롤
xdg-entry-panel-keywords = WMDE;패널;애플릿
xdg-entry-window-management = 창 관리
xdg-entry-a11y = 접근성
xdg-entry-desktop-keywords = WMDE;데스크톱;
xdg-entry-x11-applications-keywords = WMDE;X11;앱;게임;호환성;
xdg-entry-displays-comment = 표시 구성 관리 설정
xdg-entry-default-apps = 기본 앱
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;네트워크;연결;
xdg-entry-applications-comment = 기본 앱과 시작 앱 및 X11 앱 호환성 설정
xdg-entry-about-keywords = WMDE;정보
xdg-entry-panel = 패널
xdg-entry-notifications = 알림
xdg-entry-a11y-keywords = WMDE;접근성;접근성;스크린;리더;돋보기;대비;색상;
xdg-entry-wireless-comment = Wi-Fi 연결 및 연결 프로필
xdg-entry-desktop = 데스크톱
xdg-entry-date-time-keywords = WMDE;시간;대;
...
xdg-entry-bluetooth-keywords = WMDE;블루투스;
xdg-entry-dock-comment = 앱과 애플릿을 위한 선택적 바
xdg-entry-network-keywords = WMDE;네트워크;무선;WiFi;VPN;
xdg-entry-dock = 독
xdg-entry-wireless = Wi-Fi
xdg-entry-workspaces-keywords = WMDE;작업 공간;방향;개요;모니터;
xdg-entry-users-keywords = WMDE;사용자;계정;
xdg-entry-about-comment = 장치 이름, 하드웨어 정보, 운영체제 기본값
xdg-entry-vpn-keywords = WMDE;VPN;네트워크;연결;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = 강조 색상과 테마
xdg-entry-input-keywords = WMDE;입력;키보드;마우스;마우스;
xdg-entry-comment = WMDE 데스크톱을 위한 설정 앱
xdg-entry-notifications-comment = 방해 금지와 잠금 화면 알림 및 애플리케이션별 설정
xdg-entry-applications = 앱
xdg-entry-power-keywords = WMDE;전원;배터리
xdg-entry-default-apps-keywords = WMDE;기본;앱
xdg-entry-keywords = WMDE;설정;
xdg-entry-about = 정보
xdg-entry-input = 입력 장치
xdg-entry-applications-keywords = WMDE;기본;앱;시작;X11;호환성
xdg-entry-keyboard-keywords = WMDE;키보드;입력;소스;단축키;
xdg-entry-vpn-comment = VPN 연결 및 연결 프로필
xdg-entry-appearance = 외관
xdg-entry-window-management-keywords = WMDE;창;관리;타일링;Super;키;
...
xdg-entry-displays-keywords = WMDE;표시;
...
xdg-entry-startup-apps-keywords = WMDE;시작;앱;
xdg-entry-system = 시스템 & 계정
xdg-entry-time-language-comment = 시스템 날짜와 시간, 지역 및 언어 관리
xdg-entry-touchpad-keywords = WMDE;터치패드;제스처;
xdg-entry-time-language = 시간 & 언어
xdg-entry-users = 사용자
xdg-entry-system-keywords = WMDE;시스템;정보;계정;펌웨어;
...
xdg-entry-time-language-keywords = WMDE;시스템;시간;날짜;지역;언어;
xdg-entry-sound-keywords = WMDE;소리;오디오;알림;Pipewire;
xdg-entry-sound = 소리

...
appearance = Выгляд
    .desc = Дамінуючыя колеры і тэмы WMDE.
...
enable-export = Прымяніць гэтую тэму да праграм GNOME.
    .desc = Не ўсе інструменты падтрымліваюць аўтаматычнае пераключэнне. Для праграм, якія не належаць да WMDE, можа спатрэбіцца перазапуск пасля змены тэмы.

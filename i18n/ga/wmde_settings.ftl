...
vpn-error = Earráid VPN
    ...
    .openvpn-config-path = Cosán comhaid neamhbhailí do chumraíocht OpenVPN
    .openvpn-config-path-desc = Ní mór an comhad roghnaithe a bheith ar chóras comhad áitiúil.
    ...
    .wireguard-config-path-desc = Ní mór an comhad roghnaithe a bheith ar chóras comhad áitiúil.
...
enable-export = Cuir an téama seo i bhfeidhm ar aipeanna GNOME.
    .desc = Ní thacaíonn gach tacar uirlisí le huath-athrú. B’fhéidir go mbeadh gá aipeanna nach bhfuil i WMDE a atosú tar éis athrú téama.
...
style = Stíl
    ...
    .frosted-system-interface = Comhéadan córais
    .frosted-system-interface-desc = Cuireann sé gloine sioctha i bhfeidhm ar an Tosaitheoir, leabharlann feidhmchlár, forbhreathnú ar an spás oibre, rialuithe ar an scáileán
    .frosted-windows = Fuinneoga
    .frosted-windows-desc = Cuireann sé gloine sioctha i bhfeidhm ar fhuinneoga agus ar dhialóga
    .frosted-panels = Painéil
    .frosted-panels-desc = Cuireann sé gloine sioctha i bhfeidhm ar an bpainéal agus ar an duga
    .frosted-applets = Feidhmchláiríní
    .frosted-applets-desc = Cuireann sé gloine sioctha i bhfeidhm ar bhiachláir feidhmchláiríní ar an bpainéal agus ar an duga
    .frosted-thickness = Tiús sioctha
    .less = níos lú
    .more = níos mó
...
keyboard-special-char = Iontráil Carachtar Speisialta
    ...
    .swap-with-ctrl = Malartú le Ctrl
    .alt = Alt
    .alt-left = Alt ar Chlé
    .alt-right = Alt ar Dheas
    .super = Super
    .super-left = Super ar Chlé
    .super-right = Super ar Dheas
    .menu = Eochair Roghchláir
    .backspace = Spás Cúil
    .escape = Éalú
    .swap-with-escape = Malartú le hÉalú
    .print-screen = Priontáil Scáileáin
...
xdg-entry-desktop-keywords = WMDE;Deasc;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Líonra;Ceangal;
xdg-entry-about-keywords = WMDE;Maidir
xdg-entry-desktop = Deasc
xdg-entry-date-time-keywords = WMDE;Am;Crios;
...
xdg-entry-default-apps-keywords = WMDE;Réamhshocrú;Feidhmchlár
xdg-entry-keywords = WMDE;Socruithe;
xdg-entry-about = Maidir
xdg-entry-appearance = Dealramh
xdg-entry-workspaces = Spásanna Oibre
xdg-entry-mouse-keywords = WMDE;Luch;Luasghéarú;Scrolláil;
xdg-entry-keyboard-comment = Foinsí ionchuir, athrú, iontráil carachtar speisialta, aicearraí
xdg-entry-mouse = Luch
xdg-entry-dock-keywords = WMDE;Duga;Painéal;Feidhmchláirín
...
xdg-entry-dock = Duga
xdg-entry-input-keywords = WMDE;Ionchur;Méarchlár;Luch;Luchóga;
xdg-entry-input = Gléasanna Ionchuir
xdg-entry-keyboard-keywords = WMDE;Méarchlár;Ionchur;Foinse;Aicearraí;
...
xdg-entry-notifications-keywords = WMDE;Fógra;Glasáil;
xdg-entry-startup-apps-keywords = WMDE;Tosú;Feidhmchlár;
...
xdg-entry-wired-keywords = WMDE;Sreangaithe;Líonra Ceantair Áitiúil;Líonra;Nasc;
xdg-entry-power = Cumhacht & Ceallraí
xdg-entry-appearance-keywords = WMDE;Béim;Dath;Deilbhín;Cló;Téama
xdg-entry-system = Córas & Cuntais
xdg-entry-panel-keywords = WMDE;Painéal;Feidhmchláirín
...
xdg-entry-x11-applications-keywords = WMDE;X11;Feidhmchlár;Cluiche;Comhoiriúnacht;
xdg-entry-displays-comment = Bainistigh socruithe cumraíochta taispeána
xdg-entry-touchpad-keywords = WMDE;Ceap tadhaill;Gothaí;
xdg-entry-time-language = Am & Teanga
xdg-entry-users = Úsáideoirí
xdg-entry-system-keywords = WMDE;Córas;Eolas;Cuntais;Dochtearraí;
...
xdg-entry-a11y-keywords = WMDE;Inrochtaineacht;A11y;Scáileán;Léitheoir;Formhéadaitheoir;Codarsnacht;Dath;
...
xdg-entry-network-keywords = WMDE;Líonra;Gan Sreang;WiFi;VPN;
...
xdg-entry-workspaces-keywords = WMDE;Spás Oibre;Treoshuíomh;Forbhreathnú;Monatóir;
...
xdg-entry-wallpaper-keywords = WMDE;Cúlbhrat;Cúlra;Taispeántas sleamhnán;
xdg-entry-users-keywords = WMDE;Úsáideoir;Cuntas;
xdg-entry-about-comment = Ainm gléis, faisnéis crua-earraí, réamhshocruithe córais oibriúcháin
xdg-entry-vpn-keywords = WMDE;VPN;Líonra;Nasc;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Dathanna béime agus téamaí
xdg-entry-time-language-keywords = WMDE;Córas;Am;Dáta;Réigiún;Teanga;
xdg-entry-comment = Feidhmchlár socruithe don deasc WMDE
xdg-entry-notifications-comment = Ná Cuir Isteach, fógraí glasála scáileáin, agus socruithe in aghaidh an fheidhmchláir
xdg-entry-sound-keywords = WMDE;Fuaim;Cloisteáil;Foláireamh;Pipewire;
xdg-entry-power-keywords = WMDE;Cumhacht;Ceallraí
xdg-entry-region-language-keywords = WMDE;Réigiún;Teanga;Dáta;Formáid;Am;Suíomh;Logánú;
xdg-entry-applications-keywords = WMDE;Réamhshocrú;Feidhmchlár;Tosaithe;X11;Comhoiriúnacht
...
xdg-entry-window-management-keywords = WMDE;Fuinneog;Bainistíocht;Tíliú;Super;Eochair;
...
xdg-entry-displays-keywords = WMDE;Taispeántas;
...
bluetooth-display-passkey = Péireáil Bluetooth

...
style = Styl
    ...
    .frosted-system-interface-desc = Použije efekt ledového skla na spouštěč, knihovnu aplikací, přehled pracovních ploch a ovládací prvky na obrazovce
    .frosted-windows = Okna
    .frosted-windows-desc = Použije efekt ledového skla na okna a dialogy
    .frosted-panels = Panely
    .frosted-panels-desc = Použije efekt ledového skla na dok a panel
    .frosted-applets = Applety
    .frosted-applets-desc = Použije efekt ledového skla na nabídky appletů v doku a na panelu

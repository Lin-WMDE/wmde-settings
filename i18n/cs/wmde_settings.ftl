...
xdg-entry-panel-comment = Hlavní systémová lišta pro nabídky a applety
...
panel-missing = Nastavení panelu chybí
    ...
    .fix = Obnovit výchozí
applets = Applety
start-segment = Počáteční segment
...
frosted = Efekt ledového skla na systémovém rozhraní
    .desc = Použít rozmazané pozadí pro panel, dok, applety, spouštěč a knihovnu aplikací
enable-export = Použít aktuální motiv v aplikacích GNOME
    .desc = Ne všechny toolkity podporují automatické přepínání. Aplikace, které nejsou postaveny na WMDE toolkitu mohou vyžadovat restart po změně motivu.
...
icon-theme = Motiv ikon
    .desc = Použít jinou sadu ikon pro aplikace
...
style = Styl
    .round = Kulatý
    .slightly-round = Mírně zaoblený
    .square = Hranatý
    .frosted-glass = Efekt ledového skla
    .frosted-system-interface = Rozhraní systému
    .frosted-system-interface-desc = Použít efekt ledového skla pro spouštěč, knihovnu aplikací, přehled pracovních ploch a ovládací prvky na obrazovce
    .frosted-windows = Okna
    .frosted-windows-desc = Použít efekt ledového skla pro okna a dialogy
    .frosted-panels = Panely
    .frosted-panels-desc = Použít efekt ledového skla pro dok a panel
    .frosted-applets = Applety
    .frosted-applets-desc = Použít efekt ledového skla pro nabídky appletů na panelu a doku
    .frosted-thickness = Tloušťka ledu
    .less = menší
    .more = větší
    .glass-opacity = Krytí skla
...
workspaces-overview = Přehled pracovních ploch
    ...
    .launcher = Otevřít spouštěč
    .applications = Otevřít aplikace
xdg-entry-notifications-keywords = WMDE;Oznámení;Zámek;Zamykání;Zamykací;
xdg-entry-touchpad = Touchpad
xdg-entry-mouse-keywords = WMDE;Myš;Zrychlení;Rolování;
xdg-entry-startup-apps-keywords = WMDE;Automatické;Spuštění;Spouštění;Start;Aplikace;
xdg-entry-wired-keywords = WMDE;Drátové;LAN;Síť;Připojení;
xdg-entry-appearance-keywords = WMDE;Zvýraznění;Barva;Barvy;Akcent;Ikona;Ikony;Font;Písmo;Písma;Témata;Motivy;
xdg-entry-dock-keywords = WMDE;Dok;Panel;Applet;
xdg-entry-panel-keywords = WMDE;Panel;Applet;
xdg-entry-desktop-keywords = WMDE;Plocha;
xdg-entry-touchpad-keywords = WMDE;Touchpad;Gesta;
xdg-entry-system-keywords = WMDE;Systém;Informace;Účty;Účet;Firmware;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Síť;Připojení;
xdg-entry-applications-comment = Výchozí aplikace, automaticky spouštěné aplikace a nastavení kompatibility aplikací X11
xdg-entry-about-keywords = WMDE;O systému;
xdg-entry-panel = Panel
xdg-entry-a11y-keywords = WMDE;Přístupnost;A11y;Obrazovka;Obrazovky;Čtečka;Lupa;Přiblížení;Kontrast;Barva;Barvy;
xdg-entry-date-time-keywords = WMDE;Čas;Pásmo;Zóna;
xdg-entry-bluetooth-keywords = WMDE;Bluetooth;
xdg-entry-network-keywords = WMDE;Síť;Bezdrátové;WiFi;VPN;
xdg-entry-wireless = Wi-Fi
xdg-entry-wallpaper-keywords = WMDE;Tapeta;Tapety;Pozadí;Prezentace;
xdg-entry-users-keywords = WMDE;Uživatel;Uživatelé;Účet;Účty;
xdg-entry-vpn-keywords = WMDE;VPN;Síť;Připojení;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = WMDE;Systém;Čas;Datum;Region;Oblast;Jazyk;
xdg-entry-input-keywords = WMDE;Vstup;Klávesnice;Myš;Myši;
xdg-entry-comment = Aplikace nastavení pro prostředí WMDE
xdg-entry-sound-keywords = WMDE;Zvuk;Audio;Upozornění;Pipewire;
xdg-entry-power-keywords = WMDE;Napájení;Baterie;
xdg-entry-default-apps-keywords = WMDE;Výchozí;Aplikace;
xdg-entry-keywords = WMDE;Nastavení;Nastavit;
xdg-entry-region-language-keywords = WMDE;Region;Oblast;Jazyk;Datum;Formát;Čas;Lokalizace;
xdg-entry-applications-keywords = WMDE;Výchozí;Aplikace;Automatické;Spuštění;Spouštění;Start;X11;Kompatibilita;
xdg-entry-keyboard-keywords = WMDE;Klávesnice;Vstup;Zdroj;Zdroje;Metoda;Metody;Zkratky;
xdg-entry-window-management-keywords = WMDE;Okno;Okna;Správa;Dlaždicový režim;Super;Klávesa;
xdg-entry-displays-keywords = WMDE;Obrazovka;Obrazovky;Displeje;Monitory;Zobrazení;Rozlišení;Měřítko;Škálování;Orientace;Obnovovací frekvence;Variabilní;VRR;
xdg-entry-workspaces-keywords = WMDE;Pracovní;Plocha;Plochy;Orientace;Přehled;Sledování;
xdg-entry-x11-applications-keywords = WMDE;X11;Aplikace;Hra;Hry;Kompatibilita;

...
enable-export = Aktuelles Thema auf GNOME-Apps anwenden
    .desc = Nicht alle Toolkits unterstützen den automatischen Wechsel. Nicht-WMDE-Apps müssen nach einem Themenwechsel möglicherweise neu gestartet werden.
...
style = Stil
    ...
    .frosted-system-interface-desc = Wendet einen Milchglaseffekt auf den Starter, die Anwendungsbibliothek, die Arbeitsflächenübersicht und die Bildschirmsteuerelemente an
    ...
    .frosted-applets-desc = Wendet einen Milchglaseffekt auf die Applet-Menüs im Panel und im Dock an
    .frosted-thickness = Dicke der Mattierung
    .less = weniger
    .more = mehr
    .glass-opacity = Glastrübung
...
xdg-entry-dock-keywords = WMDE;Dock;Panel;Applet
...
xdg-entry-about-keywords = WMDE;Über
...
xdg-entry-dock = Dock
xdg-entry-input-keywords = WMDE;Eingabe;Tastatur;Maus;Mäuse;
xdg-entry-comment = Einstellungsanwendung für den WMDE Desktop
xdg-entry-applications = Anwendungen
xdg-entry-default-apps-keywords = WMDE;Standard;Anwendung
xdg-entry-keywords = WMDE;Einstellungen;
xdg-entry-about = Über
xdg-entry-input = Eingabegeräte
xdg-entry-applications-keywords = WMDE;Standard;Anwendung;Start;X11;Kompatibilität
xdg-entry-appearance = Aussehen
xdg-entry-displays-keywords = WMDE;Bildschirm;
save = Speichern
...
xdg-entry-x11-applications-keywords = WMDE;X11;Anwendung;Spiel;Kompatibilität;
...
xdg-entry-workspaces-keywords = WMDE;Arbeitsfläche;Ausrichtung;Übersicht;Monitor;
xdg-entry-wireless-keywords = WMDE;WLAN;Netzwerk;Verbindung;
xdg-entry-wireless-comment = WLAN-Verbindungen und Verbindungsprofile
xdg-entry-wireless = WLAN
xdg-entry-wired-keywords = WMDE;Kabelgebunden;LAN;Netzwerk;Verbindung;
xdg-entry-wired-comment = Kabelgebundene Verbindungen und Verbindungsprofile
xdg-entry-wired = Kabelgebunden
xdg-entry-window-management-keywords = WMDE;Fenster;Verwaltung;Kachelung;Super;Taste;
...
xdg-entry-sound-keywords = WMDE;Klang;Audio;Alarm;Pipewire;
xdg-entry-sound-comment = Audioeinstellungen für Geräte, Alarme und Anwendungen
xdg-entry-sound = Klang
xdg-entry-region-language-keywords = WMDE;Region;Sprache;Datum;Format;Uhrzeit;Gebietsschema;Lokalisierung;
...
xdg-entry-power-keywords = WMDE;Energie;Akku
...
xdg-entry-date-time-keywords = WMDE;Zeit;Zone;
...
xdg-entry-touchpad-keywords = WMDE;Touchpad;Geste;
...
xdg-entry-notifications-keywords = WMDE;Benachrichtigung;Sperre;
...
xdg-entry-network-keywords = WMDE;Netzwerk;Drahtlos;WLAN;VPN;
xdg-entry-network = Netzwerk & Drahtlos
xdg-entry-mouse-keywords = WMDE;Maus;Beschleunigung;Scrollen;
xdg-entry-mouse-comment = Mausgeschwindigkeit, -beschleunigung und natürliches Scrollen
xdg-entry-mouse = Maus
xdg-entry-keyboard-keywords = WMDE;Tastatur;Eingabe;Quelle;Tastenkombinationen;
...
xdg-entry-wallpaper-keywords = WMDE;Hintergrundbild;Hintergrund;Slideshow;
...
xdg-entry-appearance-keywords = WMDE;Akzent;Farbe;Symbol;Schriftart;Thema
...
xdg-entry-a11y-keywords = WMDE;Barrierefreiheit;A11y;Bildschirm;Leser;Vergrößerungsglas;Kontrast;Farbe;

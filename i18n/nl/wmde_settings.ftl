...
xdg-entry-a11y = Toegankelijkheid
xdg-entry-a11y-comment = Schermlezer, vergrootglas, hoog contrast, en kleurenfilters
xdg-entry-appearance = Uiterlijk
xdg-entry-appearance-comment = Accentkleuren en thema's
xdg-entry-applications = Toepassingen
xdg-entry-applications-comment = Standaardtoepassingen, autostart-toepassingen, en X11-compatibiliteitsinstellingen
xdg-entry-date-time = Datum en tijd
xdg-entry-date-time-comment = Tijdszone, automatische tijdinstellingen en tijdnotatie
xdg-entry-default-apps = Standaardtoepassingen
xdg-entry-default-apps-comment = Standaard webbrowser, e-mailclient, bestandsbeheerder, en andere toepassingen
...
rgb = RGB
window-hint-accent = Kleur van vensterfocus-aanduiding
window-hint-accent-toggle = Gebruik de accentkleur van het thema voor de vensterfocus-aanduiding
...
enable-export = Pas dit thema toe op GNOME-apps.
    .desc = Niet alle toolkit-omgevingen ondersteunen automatische thema wisseling. Niet-WMDE-apps moeten mogelijk opnieuw worden opgestart na een themawijziging.
...
window-management-appearance = Vensterbeheer
    .active-hint = Grootte van vensterfocus-aanduiding
...
window-controls = Vensterbeheer
    ...
    .active-window-hint = Vensterfocus-aanduiding tonen
...
power-mode = Prestaties en energieverbruik
    ...
    .performance = Krachtige prestaties
...
time-format = Datum- en tijdnotatie
    .twenty-four = 24‑uursnotatie
    .show-seconds = Seconden weergeven
    .first = De week begint op
    .show-date = Datum weergeven op het paneel
    .friday = Vrijdag
    .saturday = Zaterdag
    .sunday = Zondag
    .monday = Maandag
...
preferred-languages = Taalvoorkeur
    .desc = De volgorde van de talen bepaalt welke door WMDE wordt gebruikt. Wijzigingen worden doorgevoerd nadat u zich opnieuw heeft aangemeld.
...
xdg-entry-appearance-keywords = WMDE;Accent;Kleur;Accentkleur;Icoon;Iconen;Lettertype;Thema
xdg-entry-a11y-keywords = WMDE;Toegankelijkheid;A11y;Scherm;Lezer;Schermlezer;Vergrootglas;Contrast;Kleur;
xdg-entry-comment = Instellingentoepassing voor WMDE
xdg-entry-keywords = WMDE;Instellingen;
...
xdg-entry-desktop-keywords = WMDE;Bureaublad;
xdg-entry-about-keywords = WMDE;Over;
xdg-entry-date-time-keywords = WMDE;Tijd;Zone;Tijdzone;
...
xdg-entry-default-apps-keywords = WMDE;Standaard;Toepassing;Standaardtoepassing
xdg-entry-applications-keywords = WMDE;Standaard;Opstart;Autostart;Toepassingen;Standaardtoepassingen;Autostarttoepassingen;X11;Compatibiliteit;

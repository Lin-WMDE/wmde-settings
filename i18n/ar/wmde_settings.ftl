...
xdg-entry-desktop-comment = إعدادات خلفية الشاشة والمظهر واللوحة والإرساء وإدارة النوافذ ومساحة العمل
...
enable-export = قم بتطبيق هذا المظهر على تطبيقات GNOME.
    .desc = لا تدعم جميع مجموعات الأدوات التبديل التلقائي. قد تحتاج التطبيقات غير التابعة لـ WMDE إلى إعادة التشغيل بعد تغيير المظهر.
icon-theme = نسق الأيقونات
    .desc = يطبِّق مجموعة مختلفة من الأيقونات على التطبيقات
...
style = الأسلوب
    ...
    .square = مربع
    .frosted-glass = زجاج بلوري
    .frosted-system-interface = واجهة النظام
    .frosted-system-interface-desc = يُطبِّق مظهر الزجاج البلوري على المشغّل، ومكتبة التطبيقات، ونظرة عامة على مساحة العمل، وعناصر التحكم التي تظهر على الشاشة
    .frosted-windows = النوافذ
    .frosted-windows-desc = يطبِّق مظهر الزجاج البلوري على النوافذ ومربعات الحوار
    .frosted-panels = اللوحات
    .frosted-panels-desc = يطبِّق الزجاج البلوري على اللوحة وقاعدة الإرساء
    .frosted-applets = البريمجات
    .frosted-applets-desc = يطبِّق الزجاج البلوري على قوائم البريمجات الموجودة على اللوحة والإرساء
    .frosted-thickness = السماكة البلورية
    .less = أقل
    .more = أكثر
...
keyboard-sources = مصادر الإدخال
    ...
    .remove = أزِل
    .add = أضِف مصدر إدخال
keyboard-special-char = إدخال الأحرف الخاصة
    .alternate = مفتاح الأحرف البديلة
    .compose = مفتاح التكوين
    .compose-desc = يتيح مفتاح التكوين إدخال مجموعة متنوعة من الأحرف. لاستخدامه، اضغط على مفتاح التكوين ثم سلسلة من الأحرف. على سبيل المثال، سيؤدي الضغط على مفتاح التكوين متبوعًا بالحرفين C و o إلى إدخال الرمز ©، بينما سيؤدي الضغط على مفتاح «التكوين» متبوعًا بالحرفين a و ‘ إلى إدخال الحرف á.
    .caps = مفتاح قفل الحروف
    .ctrl = مفتاح التحكم
    .ctrl-right = مفتاح Ctrl الأيمن
    .swap-with-ctrl = تبديل مع مفتاح التحكم
    .alt = مفتاح Alt
    .alt-left = مفتاح Alt الأيسر
    .alt-right = Alt الأيمن
    .super = Super
    .super-left = Super الأيسر
    .super-right = Super الأيمن
    .menu = مفتاح القائمة
    .backspace = مسافة للخلف
    .escape = هروب (ESC)
    .swap-with-escape = التبديل مع مفتاح الهروب
    .print-screen = اطبع الشاشة
...
xdg-entry-about-keywords = WMDE;عن;حول
xdg-entry-comment = تطبيق الإعدادات لسطح مكتب WMDE
xdg-entry-keywords = WMDE;إعدادات;
xdg-entry-window-management-comment = إجراء مفتاح Super وخيارات التحكم في النوافذ وخيارات إضافية تبليط النوافذ
xdg-entry-mouse-keywords = WMDE;فأرة;تسارع;تمرير;
xdg-entry-notifications-keywords = WMDE;إشعار;قفل;
xdg-entry-startup-apps-keywords = WMDE;بدء التشغيل;تطبيق;
xdg-entry-wired-keywords = WMDE;سلكي;LAN;شبكة;اتصال;
xdg-entry-appearance-keywords = WMDE;تمييز;لون;أيقونة;خط;سمة;نسق
xdg-entry-dock-keywords = WMDE;مرسى;لوحة;بريمج
xdg-entry-panel-keywords = WMDE;لوحة;بريمج
xdg-entry-window-management = إدارة النوافذ
xdg-entry-time-language-comment = أدِر نظام التاريخ والتوقيت والمنطقة واللغة
xdg-entry-desktop-keywords = WMDE;سطح المكتب;
xdg-entry-x11-applications-keywords = WMDE;X11;تطبيق;لعبة;التوافق;
xdg-entry-touchpad-keywords = WMDE;لوحة اللمس;إيماءة;
xdg-entry-system-keywords = WMDE;النظام;المعلومات;الحسابات;البرمجيات الثابتة;
xdg-entry-wireless-keywords = WMDE;واي فاي;Wi-Fi;شبكة;اتصال;
xdg-entry-applications-comment = التطبيقات المبدئية وتطبيقات بدء التشغيل وإعدادات توافق تطبيقات اكس11
xdg-entry-a11y-keywords = WMDE;الإتاحة;A11y;شاشة;قارئ;مكبر;تباين;لون;
xdg-entry-wireless-comment = اتصالات الواي فاي وملفات تعريف الاتصال
xdg-entry-date-time-keywords = WMDE;الوقت;المنطقة;
xdg-entry-wallpaper = الخلفية
xdg-entry-bluetooth-keywords = WMDE;بلوتوث;
xdg-entry-network-keywords = WMDE;شبكة;لاسلكي;واي فاي;VPN;ش‌خ‌ف;شبكة خاصة افتراضية;
xdg-entry-wallpaper-comment = صور الخلفية والألوان وخيارات عرض الشرائح
xdg-entry-wireless = واي فاي
xdg-entry-workspaces-keywords = WMDE;مساحة العمل;التوجيه;نظرة عامة;الشاشة;
xdg-entry-system-comment = معلومات النظام والحسابات وتحديثات البرامج الثابتة
xdg-entry-wallpaper-keywords = WMDE;خلفية;خلفية الشاشة;عرض شرائح;
xdg-entry-users-keywords = WMDE;مستخدم;حساب;
xdg-entry-vpn-keywords = WMDE;VPN;شبكة;اتصال;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = WMDE;النظام;الوقت;التاريخ;المنطقة;اللغة;
xdg-entry-input-keywords = WMDE;إدخال;لوحة مفاتيح;ماوس;فأرة;
xdg-entry-sound-keywords = WMDE;صوت;صوتي;تنبيه;Pipewire;
xdg-entry-power-keywords = WMDE;طاقة;مدخرة;بطارية
xdg-entry-default-apps-keywords = WMDE;مبدئي;تطبيق
xdg-entry-region-language-keywords = WMDE;المنطقة;اللغة;التاريخ;التنسيق;الوقت;الإعدادات المحلية;التوطين;
xdg-entry-applications-keywords = WMDE;افتراضي;تطبيق;بدء التشغيل;X11;توافقية;مبدئي;اكس11
xdg-entry-keyboard-keywords = WMDE;لوحة المفاتيح;الإدخال;المصدر;الاختصارات;
xdg-entry-window-management-keywords = WMDE;إدارة;النوافذ;التبليط;مفتاح;Super;
xdg-entry-workspaces-comment = اتجاه مساحة العمل ونظرة عامة وسلوك الشاشات المتعدّدة
xdg-entry-displays-keywords = WMDE;عرض;

...
xdg-entry-sound-comment = Zvukové nastavenia pre zariadenia, upozornenia a aplikácies
...
enable-export = Použiť túto tému v GNOME aplikáciách.
    .desc = Nie všetky toolkit-y podporujú automatické prepínanie. Ne-WMDE aplikácie je potrebné po zmene témy reštartovať.

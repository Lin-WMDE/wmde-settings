...
style = Στυλ
    ...
    .frosted-system-interface-desc = Εφαρμόζει το εφέ ημιδιαφανούς γυαλιού στο μενού εκκίνησης, τη βιβλιοθήκη εφαρμογών, την επισκόπηση χώρων εργασίας και τα στοιχεία ελέγχου στην οθόνη
    ...
    .less = λίγο
    .more = πολύ
    .glass-opacity = Διαφάνεια γυαλιού

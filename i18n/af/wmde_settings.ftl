...
xdg-entry-about-keywords = WMDE;Oor
xdg-entry-a11y = Toeganklikhede
xdg-entry-a11y-keywords = WMDE;Toeganklikhede;A11y;Screen;Reader;Magnifier;Contrast;Color;
xdg-entry-appearance = Weergawe
xdg-entry-appearance-comment = Aksentkleure en temas
xdg-entry-appearance-keywords = WMDE;Weergawe;Aksentkleure;Color;Icon;Font;Temas
...
xdg-entry-displays-keywords = WMDE;Vertoonskerme;
xdg-entry-dock = Dock

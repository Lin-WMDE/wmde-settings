...
vpn-error = VPN қатесі
    ...
    .openvpn-config-path = OpenVPN баптаулары үшін файлға дейінгі жол жарамсыз
    .openvpn-config-path-desc = Таңдалған файл жергілікті файлдық жүйеде болуы тиіс.
...
accessibility = Арнайы мүмкіндіктер
    ...
    .shake-cursor = Шайқаған кезде курсорды үлкейту
    .shake-cursor-desc = Курсорды уақытша үлкейту үшін, тышқанды жылдам шайқаңыз
...
enable-export = Ағымдағы тақырыпты GNOME қолданбаларына іске асыру
    .desc = Барлық интерфейс жиынтықтары автоматты түрде ауысуды қолдамайды. WMDE-ке жатпайтын қолданбаларды тақырып өзгергеннен кейін қайта іске қосу қажет болуы мүмкін.
...
style = Стиль
    ...
    .frosted-system-interface = Жүйелік интерфейс
    .frosted-system-interface-desc = Мөлдір емес шыны эффектін іске қосқыш, қолданбалар библиотекасы, жұмыс үстелі көрінісі, экрандағы басқару элементтері үшін іске асырады
    .frosted-windows = Терезелер
    .frosted-windows-desc = Мөлдір емес шыны эффектін терезелер мен сұхбат терезелері үшін іске асырады
    .frosted-panels = Панельдер
    .frosted-panels-desc = Мөлдір емес шыны эффектін панель мен бекіту панелі (док) үшін іске асырады
    .frosted-applets = Апплеттер
    .frosted-applets-desc = Мөлдір емес шыны эффектін панель мен доктағы апплеттер мәзірі үшін іске асырады
    .frosted-thickness = Мөлдір еместігінің шамасы
    .less = азырақ
    .more = көбірек
    .glass-opacity = Шынының мөлдір еместігі
...
keyboard-special-char = Арнайы таңбаларды енгізу
    ...
    .ctrl = Control
    .ctrl-right = Оң жақ Ctrl
    .swap-with-ctrl = Control-мен ауыстыру
    .alt = Alt
    .alt-left = Сол жақ Alt
    .alt-right = Оң жақ Alt
    .super = Super
    .super-left = Сол жақ Super
    .super-right = Оң жақSuper
    .menu = Menu key
    .backspace = Backspace
    .escape = Escape
    .swap-with-escape = Escape-пен алмастыру
...
xdg-entry-mouse-keywords = WMDE;Тышқан;Үдеу;Айналдыру;
xdg-entry-bluetooth-comment = Bluetooth құрылғыларын басқару
xdg-entry-notifications-keywords = WMDE;Хабарландыру;Құлыптау;
xdg-entry-startup-apps-keywords = WMDE;Автоқосылу;Қолданба;
...
xdg-entry-wired-keywords = WMDE;Сымды;LAN;Желі;Қосылым;
xdg-entry-power = Қуат және батарея
xdg-entry-appearance-keywords = WMDE;Акцент;Түс;Таңбаша;Қаріп;Тема
...
xdg-entry-desktop-keywords = WMDE;Жұмыс үстелі;
xdg-entry-x11-applications-keywords = WMDE;X11;Қолданба;Ойын;Үйлесімділік;
xdg-entry-displays-comment = Экран конфигурациясының баптауларын басқару
xdg-entry-touchpad-keywords = WMDE;Тачпад;Қимыл;
xdg-entry-time-language = Уақыт және тіл
xdg-entry-users = Пайдаланушылар
xdg-entry-system-keywords = WMDE;Жүйе;Ақпарат;Тіркелгілер;Микробағдарлама;
xdg-entry-default-apps = Әдепкі қолданбалар
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Желі;Қосылым;
...
xdg-entry-about-keywords = WMDE;Осы туралы
xdg-entry-panel = Панель
xdg-entry-notifications = Хабарландырулар
xdg-entry-a11y-keywords = WMDE;Арнайы мүмкіндіктер;A11y;Экран;Диктор;Лупа;Контраст;Түс;
xdg-entry-wireless-comment = Wi-Fi қосылымдары және қосылымдар профильдері
xdg-entry-desktop = Жұмыс үстелі
xdg-entry-date-time-keywords = WMDE;Уақыт;Белдеу;
...
xdg-entry-network-keywords = WMDE;Желі;Сымсыз;WiFi;VPN;
...
xdg-entry-workspaces-keywords = WMDE;Жұмыс орны;Бағдар;Шолу;Монитор;
...
xdg-entry-wallpaper-keywords = WMDE;Тұсқағаз;Фон;Слайдшоу;
xdg-entry-users-keywords = WMDE;Пайдаланушы;Тіркелгі;
xdg-entry-about-comment = Құрылғы аты, жабдық туралы ақпарат, операциялық жүйенің әдепкі параметрлері
xdg-entry-vpn-keywords = WMDE;VPN;Желі;Байланыс;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Акцентті түстер және темалар
xdg-entry-time-language-keywords = WMDE;Жүйе;Уақыт;Күн;Аймақ;Тіл;
xdg-entry-input-keywords = WMDE;Енгізу;Пернетақта;Тышқан;Тышқандар;
xdg-entry-comment = WMDE жұмыс үстеліне арналған баптаулар қолданбасы
...
xdg-entry-sound-keywords = WMDE;Дыбыс;Аудио;Ескерту;Pipewire;
xdg-entry-power-keywords = WMDE;Қуат;Батарея
xdg-entry-default-apps-keywords = WMDE;Әдепкі;Қолданба
xdg-entry-keywords = WMDE;Баптаулар;
xdg-entry-region-language-keywords = WMDE;Аймақ;Тіл;Күн;Пішім;Уақыт;Локаль;Локализация;
xdg-entry-about = Осы туралы
xdg-entry-input = Енгізу құрылғылары
xdg-entry-applications-keywords = WMDE;Әдепкі;Қолданба;Автоқосылу;X11;Үйлесімділік
...
xdg-entry-keyboard-keywords = WMDE;Пернетақта;Енгізу;Көз;Жарлықтар;
xdg-entry-vpn-comment = VPN байланыстары және байланыс профильдері
xdg-entry-appearance = Сыртқы түрі
xdg-entry-window-management-keywords = WMDE;Терезе;Басқару;Қатар қою;Super;Перне;
...
xdg-entry-displays-keywords = WMDE;Экран;
...
bluetooth-display-passkey = Bluetooth жұптау
    .description = { $device } құрылғысында келесі кілттік кодты енгізіңіз, одан кейін Enter басыңыз
bluetooth-display-pin = Bluetooth жұптау
    .description = { $device } құрылғысында келесі PIN кодты енгізіңіз, одан кейін Enter басыңыз

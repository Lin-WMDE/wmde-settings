...
enable-export = Używaj tego motywu w aplikacjach GNOME.
    .desc = Nie wszystkie toolkity wspierają automatyczne zmiany. Aplikacje spoza WMDE mogą wymagać restartu po zmianie motywu.
...
style = Styl
    ...
    .frosted-system-interface = Interfejs systemu
    .frosted-system-interface-desc = Użyj oszronionego szkła do Programu startowego, biblioteki aplikacji, podglądu obszarów roboczych i elementów kontrolnych na ekranie
    .frosted-windows = Okna
    .frosted-windows-desc = Użyj oszronionego szkła w oknach i dialogach
    .frosted-panels = Panele
    .frosted-panels-desc = Użyj oszronionego szkła w panelach i doku
    .frosted-applets = Aplety
    .frosted-applets-desc = Użyj oszronionego szkła w apletach menu na panelu i doku
    .frosted-thickness = Grubość szronu
    .less = mniej
    .more = więcej
    .glass-opacity = Przeźroczystość szkła
...
keyboard-special-char = Wpis znaków specjalnych
    ...
    .ctrl = Control
    .ctrl-right = Prawy Ctrl
    .swap-with-ctrl = Zamień z Control
    .alt = Alt
    .alt-left = Lewy Alt
    .alt-right = Prawy Alt
    .super = Super
    .super-left = Lewy Super
    .super-right = Prawy Super
    .menu = Klawisz Menu
    .backspace = Backspace
    .escape = Escape
    .swap-with-escape = Zamień zEscape
...
workspaces-overview = Podgląd obszarów roboczych
    ...
    .launcher = Otwórz Program Startowy
    .applications = Otwórz Aplikacje
xdg-entry-mouse-keywords = WMDE;Mysz;Myszka;Przyśpieszenie;Akceleracja;Skrolowanie;Scrollowanie;
xdg-entry-notifications-keywords = WMDE;Powiadomienia;Blokada;
xdg-entry-startup-apps-keywords = WMDE;Aplikacje Startowe;Aplikacje;
xdg-entry-wired-keywords = WMDE;Przewodowe;LAN;Sieć;Łącze;
xdg-entry-appearance-keywords = WMDE;Akcenty;Kolor;Ikony;Czcionki;Wygląd;Styl
xdg-entry-dock-keywords = WMDE;Dok;Panel;Aplet
xdg-entry-panel-keywords = WMDE;Panel;Aplet
xdg-entry-time-language-comment = Zarządzaj datą, czasem, regionem i językiem systemu
xdg-entry-desktop-keywords = WMDE;Środowisko Graficzne;
xdg-entry-x11-applications-keywords = WMDE;X11;Aplikacje;Gry;Zgodność;
xdg-entry-touchpad-keywords = WMDE;Gładzik;Gesty;
xdg-entry-system-keywords = WMDE;System;Informacje;Konta;Firmware;Mikrooprogramowanie;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Sieć;Połączenie;Łącze;
xdg-entry-applications-comment = Domyślne aplikacje, aplikacje startowe oraz ustawienia zgodności aplikacji X11
xdg-entry-about-keywords = WMDE;O programie
xdg-entry-a11y-keywords = WMDE;Dostępność;A11y;Ekran;Czytnik;Lupa;Kontrast;Kolor;
xdg-entry-date-time-keywords = WMDE;Czas;Strefa Czasowa;
...
xdg-entry-network-keywords = WMDE;Sieci;Bezprzewodowe;WIFI;VPN;
xdg-entry-wireless = WI-FI
xdg-entry-workspaces-keywords = WMDE;Obszary Robocze;Orientacja;Kierunek;Podgląd;Monitor;Wyświetlacz;
xdg-entry-system-comment = Informacje o Systemie, konta i aktualizacje firmware
xdg-entry-wallpaper-keywords = WMDE;Tapeta;Tło;Pokaz Slajdów;Slajdy;
xdg-entry-users-keywords = WMDE;Użytkownik;Konto;
xdg-entry-vpn-keywords = WMDE;VPN;Sieć;Połączenie;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = WMDE;System;Czas;Data;Region;Język;
xdg-entry-input-keywords = WMDE;Wejście;Klawiatura;Mysz;Myszka;
xdg-entry-comment = Aplikacja ustawień dla środowiska graficznego WMDE
xdg-entry-sound-keywords = WMDE;Dźwięk;Audio;Powiadomienie; Pipewire;
xdg-entry-power-keywords = WMDE;Zasilanie;Bateria
xdg-entry-default-apps-keywords = WMDE;Dosyślne;Aplikacje
xdg-entry-keywords = WMDE;Ustawienia;
xdg-entry-region-language-keywords = WMDE;Region;Język;Data;Format;Czas;Ustawienia Regionalne;Położenie;Lokalizacja;
xdg-entry-applications-keywords = WMDE;Domyślnie;Aplikacje;Startowe;X11;Zgodność
xdg-entry-keyboard-keywords = WMDE;Klawiatura;Wejście;Źródła;Skróty;
xdg-entry-window-management-keywords = WMDE;Okna;Zarządzanie;Kafelkowanie;Super;Klawisz;Przycisk;
xdg-entry-panel-comment = Podstawowy panel z menu i apletami
xdg-entry-displays-keywords = WMDE;Wyświetlacz;Ekran;

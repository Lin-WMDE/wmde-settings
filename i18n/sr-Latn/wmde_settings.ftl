...
enable-export = Primeni ovu temu na GNOME aplikacije.
    .desc = Automatsku promenu teme ne podržavaju sve aplikacije. Ne-WMDE aplikacije će možda morati da se ponovo pokrenu nakon promene teme.

...
frosted = Effet de verre dépoli dans l'interface système
...
enable-export = Appliquer ce thème aux applications GNOME
    .desc = Certaines boîtes à outils ne supportent pas le changement automatique de thème. Les applications non-WMDE peuvent nécessiter un redémarrage après un changement de thème.
...
style = Style
    .round = Arrondi
    .slightly-round = Légèrement arrondi
    .square = Carré
    .frosted-glass = Verre dépoli
    .frosted-system-interface = Interface système
    .frosted-system-interface-desc = Applique un effet de verre dépoli au lanceur, à la bibliothèque d’applications, à la vue d’ensemble de l’espace de travail et aux contrôles à l’écran
    .frosted-windows = Fenêtres
    .frosted-windows-desc = Applique un effet de verre dépoli aux fenêtres et aux boîtes de dialogue
    .frosted-panels = Panneaux
    .frosted-panels-desc = Applique un effet de verre dépoli au panneau et au dock
    .frosted-applets = Applets
    .frosted-applets-desc = Applique un effet de verre dépoli aux menus des applets du panneau et du dock
    .frosted-thickness = Épaisseur du verre dépoli
    .less = moins
    .more = plus
...
keyboard-special-char = Saisie de caractères spéciaux
    ...
    .ctrl = Ctrl
    .ctrl-right = Ctrl Droite
    .swap-with-ctrl = Echanger avec Ctrl
    .alt = Alt
    .alt-left = Alt Gauche
    .alt-right = Alt Droite
    .super = Super
    .super-left = Super Gauche
    .super-right = Super Droite
    .menu = Touche de menu
    .backspace = Retour arrière
    .escape = Echap
    .swap-with-escape = Echanger avec Echap
...
workspaces-overview = Aperçu des espaces de travail
    ...
    .launcher = Ouvrir le lanceur
    .applications = Ouvrir les applications
xdg-entry-mouse-keywords = WMDE;Souris;Accélération;Défilement;
xdg-entry-notifications-keywords = WMDE;Notification;Verrouillage;
xdg-entry-startup-apps-keywords = WMDE;Démarrage;Application;
xdg-entry-wired-keywords = WMDE;Filaire;LAN;Réseau;Connexion;
xdg-entry-appearance-keywords = WMDE;Accentuation;Couleur;Icône;Police;Thème
xdg-entry-dock-keywords = WMDE;Dock;Panneau;Applet
xdg-entry-panel-keywords = WMDE;Panneau;Applet
xdg-entry-time-language-comment = Gérer la date, l’heure, la région et la langue du système
xdg-entry-desktop-keywords = WMDE;Bureau;
xdg-entry-x11-applications-keywords = WMDE;X11;Application;Jeu;Compatibilité;
xdg-entry-touchpad-keywords = WMDE;Pavé tactile;Gestes;
xdg-entry-system-keywords = WMDE;Système;Info;Comptes;Firmware;
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Réseau;Connexion;
xdg-entry-about-keywords = WMDE;À propos
xdg-entry-a11y-keywords = WMDE;Accessibilité,A11y;Écran;Lecteur;Loupe;Contraste;Couleur;
xdg-entry-date-time-keywords = WMDE;Horaire;Fuseau;
...
xdg-entry-network-keywords = WMDE;Réseau;Sans fil;Wi-Fi;VPN;
xdg-entry-wireless = Wi-Fi
xdg-entry-workspaces-keywords = WMDE;Espace de travail;Orientation;Aperçu;Écran;
xdg-entry-system-comment = Informations système, comptes et mises à jour du firmware
xdg-entry-wallpaper-keywords = WMDE;Fond d'écran;Arrière-plan;Diaporama;
xdg-entry-users-keywords = WMDE;Utilisateur;Compte;
xdg-entry-vpn-keywords = WMDE;VPN;Réseau;Connexion;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = WMDE;Système;Heure;Date;Région;Langue;
xdg-entry-input-keywords = WMDE;Saisie;Clavier;Souris;Souris;
xdg-entry-comment = Application Paramètres pour le bureau WMDE
xdg-entry-sound-keywords = WMDE;Son;Audio;Alerte;Pipewire;
xdg-entry-power-keywords = WMDE;Alimentation;Batterie
xdg-entry-default-apps-keywords = WMDE;Défaut;Application
xdg-entry-keywords = WMDE;Paramètres;
xdg-entry-region-language-keywords = WMDE;Région;Langue;Date;Format;Heure;Paramètres régionaux;Localisation;
xdg-entry-applications-keywords = WMDE;Défaut;Application;Démarrage;X11;Compatibilité
xdg-entry-keyboard-keywords = WMDE;Clavier;Saisie;Source;Raccourcis;
xdg-entry-window-management-keywords = WMDE;Fenêtre;Gestion;Agencement;Super;Touche;
xdg-entry-displays-keywords = WMDE;Écran;

...
import = Импорт
light = Светлая
mode-and-colors = Цвета и тема оформления
...
auto-switch = Автоматически переключать тему
    .sunrise = Сменится на светлую при восходе
    .sunset = Сменится на тёмную при закате
    .next-sunrise = Сменится на светлую при следующем восходе
    .next-sunset = Сменится на тёмную при следующем закате
...
enable-export = Применить текущее оформление к приложениям GNOME.
    .desc = Не все наборы инструментов поддерживают автоматическое переключение. После смены темы может потребоваться перезапуск приложений, не относящихся к WMDE.
...
style = Стиль
    ...
    .frosted-glass = Эффект матового стекла
    .frosted-system-interface = Системный интерфейс
    .frosted-system-interface-desc = Применяет эффект матового стекла к панели запуска, библиотеке приложений, обзору рабочих столов и экранным элементам управления
    .frosted-windows = Окна
    .frosted-windows-desc = Применяет эффект матового стекла к окнам и диалогам
    .frosted-panels = Панели
    .frosted-panels-desc = Применяет эффект матового стекла к панели и доку
    .frosted-applets = Апплеты
    .frosted-applets-desc = Применяет эффект матового стекла к меню апплетов на панели и в доке
    .frosted-thickness = Степень матовости
    .less = мин
    .more = макс
...
keyboard-special-char = Ввод специальных символов
    ...
    .ctrl = Control
    .ctrl-right = Правый Ctrl
    .swap-with-ctrl = Замена Control
    .alt = Alt
    .alt-left = Левый Alt
    .alt-right = Правый Alt
    .super = Super
    .super-left = Левый Super
    .super-right = Правый Super
    .menu = Клавиша «Меню»
    .backspace = Backspace
    .escape = Escape
    .swap-with-escape = Замена Escape
...
xdg-entry-mouse-keywords = WMDE;Мышь;Ускорение;Прокрутка;Скроллинг;
xdg-entry-bluetooth-comment = Управление Bluetooth-устройствами
xdg-entry-notifications-keywords = WMDE;Уведомления;Блокировка;
xdg-entry-startup-apps-keywords = WMDE;Автозапуск;Автозагрузка;Приложение;
...
xdg-entry-wired-keywords = WMDE;Проводная;LAN;Сеть;Подключение;Соединение;
xdg-entry-power = Питание и аккумулятор
xdg-entry-appearance-keywords = WMDE;Акцентный;Цвет;Иконки;Значки;Шрифт;Тема;Оформление
xdg-entry-mouse = Мышь
xdg-entry-dock-keywords = WMDE;Док;Панель;Апплет
xdg-entry-mouse-comment = Скорость мыши, ускорение и естественная прокрутка
xdg-entry-system = Система и учётные записи
xdg-entry-panel-keywords = WMDE;Панель;Апплет
...
xdg-entry-desktop-keywords = WMDE;Рабочий;Стол;
xdg-entry-x11-applications-keywords = WMDE;X11;Иксы;Приложение;Игра;Совместимость;
xdg-entry-displays-comment = Управление параметрами конфигурации экранов
xdg-entry-touchpad-keywords = WMDE;Сенсорная;Панель;Тачпад;Жесты;
xdg-entry-time-language = Время и язык
xdg-entry-users = Пользователи
xdg-entry-system-keywords = WMDE;Система;Информация;Сведения;Учетные;Записи;Аккаунты;Прошивка;
xdg-entry-default-apps = Приложения по умолчанию
xdg-entry-wireless-keywords = WMDE;WiFi;Wi-Fi;Вайфай;Сеть;Подключение;Соединение;
xdg-entry-applications-comment = Приложения по умолчанию, автозагрузка и совместимость приложений для X11
xdg-entry-about-keywords = WMDE;О:Системе;Сведения
xdg-entry-panel = Панель
xdg-entry-notifications = Уведомления
xdg-entry-a11y-keywords = WMDE;Доступность;A11y;Экранный;Диктор;Лупа;Контраст;Цвет;Специальные;Возможности;
xdg-entry-wireless-comment = Wi-Fi-соединения и профили
xdg-entry-desktop = Рабочий стол
xdg-entry-date-time-keywords = WMDE;Время;Часовой;Пояс;Зона;
...
xdg-entry-bluetooth-keywords = WMDE;Bluetooth;Блютуз;
xdg-entry-dock-comment = Дополнительная панель для приложений и апплетов
xdg-entry-network-keywords = WMDE;Сеть;Беспроводная;Связь;WiFi;VPN;Вайфай;ВПН;
...
xdg-entry-workspaces-keywords = WMDE;Рабочий;Стол;Ориентация;Обзор;Монитор;
...
xdg-entry-wallpaper-keywords = WMDE;Обои;Фон;Слайд-шоу;
xdg-entry-users-keywords = WMDE;Пользователь;Учетная;Учётная;Запись;Аккаунт;
xdg-entry-about-comment = Имя устройства, информация об оборудовании, параметры операционной системы по умолчанию
xdg-entry-vpn-keywords = WMDE;VPN;ВПН;Сеть;Подключение;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Акцентные цвета и оформление
xdg-entry-time-language-keywords = WMDE;Система;Время;Дата;Регион;Язык;
xdg-entry-input-keywords = WMDE;Ввод;Клавиатура;Мышь;Мышка;
xdg-entry-comment = Приложение параметров для рабочей среды WMDE
...
xdg-entry-sound-keywords = WMDE;Звук;Аудио;Оповещение;Pipewire;
xdg-entry-power-keywords = WMDE;Питание;Аккумулятор;Батарея
xdg-entry-default-apps-keywords = WMDE;По;умолчанию;Приложения
xdg-entry-keywords = WMDE;Параметры;Настройки;
xdg-entry-region-language-keywords = WMDE;Регион;Язык;Дата;Формат;Время;Языковая;Локаль;Локализация;
xdg-entry-about = Сведения
xdg-entry-input = Устройства ввода
xdg-entry-applications-keywords = WMDE;По;умолчанию;Приложения;Запуск;X11;Иксы;Совместимость;Автозапуск;Автозагрузка
...
xdg-entry-keyboard-keywords = WMDE;Клавиатура;Ввод;Источник;Горячие;Клавиши;Клавиш;Сочетания;Раскладки;
xdg-entry-vpn-comment = VPN-соединения и профили
xdg-entry-appearance = Внешний вид
xdg-entry-window-management-keywords = WMDE;Окно;Управление;Размещение;Тайлинг;Супер;Super;Клавиша;
...
xdg-entry-displays-keywords = WMDE;Экран;Монитор;Дисплей;

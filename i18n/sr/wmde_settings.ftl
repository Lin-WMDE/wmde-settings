...
enable-export = Примени тренутну тему на Гномове програме
    .desc = Не подржавају сви скупови алата самостално пребацивање. Програме који нису WMDE може бити потребно поново покренути након промене теме.
number = { $number }
...
xdg-entry-mouse-keywords = WMDE;Mouse;Acceleration;Scrolling;миш;убрзање;помицање;miš;ubrzanje;pomicanje;
xdg-entry-bluetooth-comment = Управљај Блутут уређајима
xdg-entry-notifications-keywords = WMDE;Notification;Lock;обавештење;закључавање;obaveštenje;zaključavanje;
xdg-entry-startup-apps-keywords = WMDE;Startup;Application;Покретање;Програм;pokretanje;program;
...
xdg-entry-wired-keywords = WMDE;Wired;LAN;Network;Connection;Жичана;ЛАН;Мрежа;Веза;žičana;lan;mreža;veza;
xdg-entry-power = Напајање и батерија
xdg-entry-appearance-keywords = WMDE;Accent;Color;Icon;Font;Theme;Нагласак;Боја;Иконица;Фонт;Тема;naglasak;boja;ikonica;font;tema
xdg-entry-mouse = Миш
xdg-entry-dock-keywords = WMDE;Dock;Panel;Applet;Док;Окно;Програмчић;dok;okno;programčić
bluetooth = Блутут
...
firmware = Фирмвер
xdg-entry-panel-keywords = WMDE;Panel;Applet;површ;програмчић;površ;programčić
...
xdg-entry-desktop-keywords = WMDE;Desktop;Радна површина;radna površina;
...
xdg-entry-x11-applications-keywords = WMDE;X11;Application;Game;Compatibility;Икс-11;Програм;Игрица;Усаглашеност;iks-11;program;igrica;usaglašenost;
xdg-entry-displays-comment = Управљај подешавањима поставки екрана
xdg-entry-touchpad-keywords = WMDE;Touchpad;Gesture;додирна табла;гест;dodirna tabla;gest;
xdg-entry-time-language = Време и језик
xdg-entry-users = Корисници
window-management = Управљање прозорима
xdg-entry-system-keywords = WMDE;System;Info;Accounts;Firmware;Систем;Подаци;Налози;Фирмвер;sistem;podaci;nalozi;firmver;
xdg-entry-default-apps = Подразумевани програми
xdg-entry-wireless-keywords = WMDE;Бежична;Вај-фај;Мрежа;Веза;
...
dock = Док
xdg-entry-about-keywords = WMDE;About;О програму;O programu
...
xdg-entry-a11y-keywords = WMDE;Accessibility;A11y;Screen;Reader;Magnifier;Contrast;Color;Приступачност;Екран;Читач;Лупа;Контраст;Боја;pristupačnost;ekran;čitač;lupa;kontrast;boja;
xdg-entry-wireless-comment = Бежичне везе и профили везе
xdg-entry-desktop = Радна површина
xdg-entry-date-time-keywords = WMDE;Time;Zone;Време;Зона;vreme;zona;
...
xdg-entry-bluetooth-keywords = WMDE;Bluetooth;Блутут;blutut;
about = О систему
input-devices = Улазни уређаји
xdg-entry-dock-comment = Необавезна трака за апликације и програмчиће
xdg-entry-network-keywords = WMDE;Network;Wireless;WiFi;VPN;мрежа;бежична веза;бежична;ВПН;mreža;bežična veza;bežična;vpn;
...
xdg-entry-workspaces-keywords = WMDE;WiFi;Wi-Fi;Network;Connection;Радни простор;Смер;Преглед;Монитор;radni prostor;smer;pregled;monitor;
...
panel = Трака
xdg-entry-wallpaper-keywords = WMDE;Wallpaper;Background;Slideshow;позадина;позадина;покретни приказ;pozadina;pozadina;pokretni prikaz;
xdg-entry-users-keywords = WMDE;User;Account;корисник;налог;korisnik;nalog;
xdg-entry-about-comment = Назив уређаја, подаци о хардверу, подразумевана подешавања оперативног система
xdg-entry-vpn-keywords = WMDE;VPN;Network;Connection;OpenVPN;OpenConnect;ВПН;мрежа;веза;ОпенВПН;ОпенКонект;vpn;mreža;veza;openvpn;openkonekt;
users = Корисници
    .admin = Админ
    .standard = Обичан
    .profile-add = Изаберите слику профила
xdg-entry-appearance-comment = Боје нагласка и теме
xdg-entry-time-language-keywords = WMDE;System;Time;Date;Region;Language;систем;време;датум;област;језик;sistem;vreme;datum;oblast;jezik;
xdg-entry-input-keywords = WMDE;Input;Keyboard;Mouse;Mice;Унос;Тастатура;Миш;Мишеви;unos;tastatura;miš;miševi;
xdg-entry-comment = Програм Подешавања за WMDE радну површину
...
xdg-entry-sound-keywords = WMDE;Sound;Audio;Alert;Pipewire;Звук;Аудио;Упозорење;Пајпвајер;zvuk;audio;upozorenje;pajpvajer;
xdg-entry-power-keywords = WMDE;Power;Battery;Напајање;Батерија;napajanje;baterija
legacy-applications = Усаглашеност програма Икс-11
xdg-entry-default-apps-keywords = WMDE;Default;Application;Подразумевано;Програм;podrazumevano;program
xdg-entry-keywords = WMDE;Settings;Подешавања;podešavanja;
xdg-entry-region-language-keywords = WMDE;Region;Language;Date;Format;Time;Locale;Localization;Регион;Језик;Датум;Формат;Време;Локалитет;Локализација;region;jezik;datum;format;vreme;lokalitet;lokalizacija;
xdg-entry-about = О програму
xdg-entry-input = Улазни уређаји
xdg-entry-applications-keywords = WMDE;Default;Application;Startup;X11;Compatibility;Подразумевано;Програм;Покретање;Икс-11;Усаглашеност;podrazumevano;program;pokretanje;iks-11;usaglašenost
...
xdg-entry-keyboard-keywords = WMDE;Keyboard;Input;Source;Shortcuts;тастатура;унос;извор;пречице;tastatura;unos;izvor;prečice;
xdg-entry-vpn-comment = ВПН везе и профили везе
keyboard = Тастатура
xdg-entry-appearance = Изглед
xdg-entry-window-management-keywords = WMDE;Window;Management;Tiling;Super;Key;Прозор;Управљање;Поплочавање;Супер;Тастер;prozor;upravljanje;popločavanje;super;taster;
...
xdg-entry-displays-keywords = WMDE;Display;Екран;ekran;
time = Време и језик

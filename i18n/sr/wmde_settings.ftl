...
xdg-entry-mouse-keywords = WMDE;Mouse;Acceleration;Scrolling;Космик;миш;убрзање;помицање;Kosmik;miš;ubrzanje;pomicanje;
xdg-entry-bluetooth-comment = Управљај Блутут уређајима
xdg-entry-notifications-keywords = WMDE;Notification;Lock;Космик;обавештење;закључавање;Kosmik;obaveštenje;zaključavanje;
xdg-entry-startup-apps-keywords = WMDE;Startup;Application;Космик;Покретање;Програм;kosmik;pokretanje;program;
...
xdg-entry-wired-keywords = WMDE;Wired;LAN;Network;Connection;Космик;Жичана;ЛАН;Мрежа;Веза;kosmik;žičana;lan;mreža;veza;
xdg-entry-power = Напајање и батерија
xdg-entry-appearance-keywords = WMDE;Accent;Color;Icon;Font;Theme;Космик;Нагласак;Боја;Иконица;Фонт;Тема;kosmik;naglasak;boja;ikonica;font;tema
xdg-entry-mouse = Миш
xdg-entry-dock-keywords = WMDE;Dock;Panel;Applet;Космик;Док;Окно;Програмчић;kosmik;dok;okno;programčić
bluetooth = Блутут
...
firmware = Фирмвер
xdg-entry-panel-keywords = WMDE;Panel;Applet;Космик;површ;програмчић;Kosmik;površ;programčić
...
xdg-entry-desktop-keywords = WMDE;Desktop;Космик;Радна површина;kosmik;radna površina;
...
xdg-entry-x11-applications-keywords = WMDE;X11;Application;Game;Compatibility;Космик;Икс-11;Програм;Игрица;Усаглашеност;kosmik;iks-11;program;igrica;usaglašenost;
xdg-entry-displays-comment = Управљај подешавањима поставки екрана
xdg-entry-touchpad-keywords = WMDE;Touchpad;Gesture;Космик;додирна табла;гест;Kosmik;dodirna tabla;gest;
xdg-entry-time-language = Време и језик
xdg-entry-users = Корисници
window-management = Управљање прозорима
xdg-entry-system-keywords = WMDE;System;Info;Accounts;Firmware;Космик;Систем;Подаци;Налози;Фирмвер;kosmik;sistem;podaci;nalozi;firmver;
...
dock = Док
xdg-entry-about-keywords = WMDE;About;Космик;О програму;Kosmik;O programu
...
xdg-entry-a11y-keywords = WMDE;Accessibility;A11y;Screen;Reader;Magnifier;Contrast;Color;Космик;Приступачност;Екран;Читач;Лупа;Контраст;Боја;kosmik;pristupačnost;ekran;čitač;lupa;kontrast;boja;
xdg-entry-wireless-comment = Бежичне везе и профили везе
xdg-entry-desktop = Радна површина
xdg-entry-date-time-keywords = WMDE;Time;Zone;Космик;Време;Зона;kosmik;vreme;zona;
...
xdg-entry-bluetooth-keywords = WMDE;Bluetooth;Космик;Блутут;kosmik;blutut;
about = О систему
input-devices = Улазни уређаји
xdg-entry-dock-comment = Необавезна трака за апликације и програмчиће
xdg-entry-network-keywords = WMDE;Network;Wireless;WiFi;VPN;Космик;мрежа;бежична веза;бежична;ВПН;Kosmik;mreža;bežična veza;bežična;vpn;
...
xdg-entry-workspaces-keywords = WMDE;WiFi;Wi-Fi;Network;Connection;Космик;Радни простор;Смер;Преглед;Монитор;kosmik;radni prostor;smer;pregled;monitor;
...
panel = Трака
xdg-entry-wallpaper-keywords = WMDE;Wallpaper;Background;Slideshow;Космик;позадина;позадина;покретни приказ;Kosmik;pozadina;pozadina;pokretni prikaz;
xdg-entry-users-keywords = WMDE;User;Account;Космик;корисник;налог;Kosmik;korisnik;nalog;
xdg-entry-about-comment = Назив уређаја, подаци о хардверу, подразумевана подешавања оперативног система
xdg-entry-vpn-keywords = WMDE;VPN;Network;Connection;OpenVPN;OpenConnect;Космик;ВПН;мрежа;веза;ОпенВПН;ОпенКонект;kosmik;vpn;mreža;veza;openvpn;openkonekt;
users = Корисници
    .admin = Админ
    .standard = Обичан
    .profile-add = Изаберите слику профила
xdg-entry-appearance-comment = Боје нагласка и теме
xdg-entry-time-language-keywords = WMDE;System;Time;Date;Region;Language;Космик;систем;време;датум;област;језик;Kosmik;sistem;vreme;datum;oblast;jezik;
xdg-entry-input-keywords = WMDE;Input;Keyboard;Mouse;Mice;Космик;Унос;Тастатура;Миш;Мишеви;kosmik;unos;tastatura;miš;miševi;
...
xdg-entry-sound-keywords = WMDE;Sound;Audio;Alert;Pipewire;Космик;Звук;Аудио;Упозорење;Пајпвајер;kosmik;zvuk;audio;upozorenje;pajpvajer;
xdg-entry-power-keywords = WMDE;Power;Battery;Космик;Напајање;Батерија;kosmik;napajanje;baterija
legacy-applications = Усаглашеност програма Икс-11
xdg-entry-default-apps-keywords = WMDE;Default;Application;Космик;Подразумевано;Програм;kosmik;podrazumevano;program
xdg-entry-keywords = WMDE;Settings;Космик;Подешавања;kosmik;podešavanja;
xdg-entry-region-language-keywords = WMDE;Region;Language;Date;Format;Time;Locale;Localization;Космик;Регион;Језик;Датум;Формат;Време;Локалитет;Локализација;kosmik;region;jezik;datum;format;vreme;lokalitet;lokalizacija;
xdg-entry-about = О програму
xdg-entry-input = Улазни уређаји
xdg-entry-applications-keywords = WMDE;Default;Application;Startup;X11;Compatibility;Космик;Подразумевано;Програм;Покретање;Икс-11;Усаглашеност;kosmik;podrazumevano;program;pokretanje;iks-11;usaglašenost
...
xdg-entry-keyboard-keywords = WMDE;Keyboard;Input;Source;Shortcuts;Космик;тастатура;унос;извор;пречице;Kosmik;tastatura;unos;izvor;prečice;
xdg-entry-vpn-comment = ВПН везе и профили везе
keyboard = Тастатура
xdg-entry-appearance = Изглед
xdg-entry-window-management-keywords = WMDE;Window;Management;Tiling;Super;Key;Космик;Прозор;Управљање;Поплочавање;Супер;Тастер;kosmik;prozor;upravljanje;popločavanje;super;taster;
...
xdg-entry-displays-keywords = WMDE;Display;Космик;Екран;kosmik;ekran;
time = Време и језик

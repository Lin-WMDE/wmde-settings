...
// WMDE: the key bindings applications handle themselves, edited here rather than in
// each application.
...
fn localize_action(action: &Action) -> String {
    ...
    match action {
        ...
        Action::NextWindow => fl!("nav-shortcuts", "next-window"),
        Action::PrevWindow => fl!("nav-shortcuts", "prev-window"),
